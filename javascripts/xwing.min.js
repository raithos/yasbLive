...
${this.uitranslation("View in YASB")}: `+this.getPermaLink())),null!=(n=this.getObstacles())&&0<n.length&&0<u.length){for(u[u.length-1]=u[u.length-1].slice(0,-2),c=" |",i=0,a=n.length;i<a;i++)null!=(s=n[i])&&(c+=` ${s} /`);c=c.slice(0,-1),u.push(c)}return this.tts_textarea.val($.trim(""+u.join(""))),this.xws_textarea.val($.trim(JSON.stringify(this.toXWS()))),$("#xws-qrcode-container").text(""),$("#xws-qrcode-container").qrcode({render:"canvas",text:JSON.stringify(this.toMinimalXWS()),ec:"L",size:128})}removeAllShips(){for(;0<this.ships.length;)this.removeShip(this.ships[0]);if(0<this.ships.length)throw new Error(this.uitranslation("Ships not emptied"))}showTextListModal(){return this.list_modal.modal("show")}showXWSModal(t){return this.select_xws_view(),this.showTextListModal()}showChooseObstaclesModal(){return this.obstacles_select.select2("val",this.current_squad.additional_data.obstacles),this.choose_obstacles_modal.modal("show")}showObstaclesSelectInfo(){var t,i,e,a,s,n=this.obstacles_select.val().split(",");if(n===[])return this.obstacles_select_sources.html("");for(e="",t=0,i=n.length;t<i;t++)e+=`<u>${s=n[t]}</u>: ${1<(s=null!=(s=null!=(s=exportObj.obstacles[s])?s.sources:void 0)?s:[]).length||(a=exportObj.translate("sources","Loose Ships"),!(0<=indexOf.call(s,a)))?0<s.length?s.join(", "):exportObj.translate("ui","unreleased"):this.uitranslation("Only available from 1st edition")}</br>`;return this.obstacles_select_sources.html($.trim(e))}updateObstacleSelect(t){return this.current_obstacles=null!=t?t:[],this.obstacles_select.select2("val",t),this.showObstaclesSelectInfo()}serialize(){var s;return`v9Z${function(){switch(this.game_type_selector.val()){case"standard":return"h";case"extended":return"s";case"xwabeta":return"b";case"epic":return"e";case"quickbuild":return"q"}}.call(this)}Z${$.trim(this.desired_points_input.val())}Z`+function(){for(var t=this.ships,i=[],e=0,a=t.length;e<a;e++)null==(s=t[e]).pilot||this.isQuickbuild&&!s.primary||i.push(s.toSerialized());return i}.call(this).join("Y")}changeGameTypeOnSquadLoad(t){if(this.game_type_selector.val()!==t)return $(window).trigger("xwing:gameTypeChanged",t)}loadFromSerialized(t){var i,e,a,s,n,l,o,r,d,c,u,h,p,f;if(this.suppress_automatic_new_ship=!0,this.removeAllShips(),null!=(t=(0<=indexOf.call(t,"Z")?/^v(\d+)Z(.*)/:/^v(\d+)!(.*)/).exec(t))){if(h=7<(f=parseInt(t[1]))?"Y":";",[t,i,c]=7<f?([i,c,r]=t[2].split("Z"),[i,parseInt(c),r]):([t,r]=t[2].split("!"),c=parseInt(t.split("=")[1])?parseInt(t.split("=")[1]):20,[i=t.split("=")[0],c,r]),f<9)return this.old_version_container.toggleClass("d-none",!1),this.suppress_automatic_new_ship=!1,void this.addShip();if(null==c)return this.loading_failed_container.toggleClass("d-none",!1),this.suppress_automatic_new_ship=!1,void this.addShip();switch(t){case"s":this.changeGameTypeOnSquadLoad("extended");break;case"h":this.changeGameTypeOnSquadLoad("standard");break;case"b":this.changeGameTypeOnSquadLoad("xwabeta");break;case"e":this.changeGameTypeOnSquadLoad("epic");break;case"q":this.changeGameTypeOnSquadLoad("quickbuild")}if(this.desired_points_input.val(i),this.desired_points_input.change(),p=[],null!=c.length){for(e=0,s=(o=c.split(h)).length;e<s;e++)""===(d=o[e])||(l=this.addShip()).fromSerialized(f,d)&&l.pilot||p.push([l,d]);for(a=0,n=p.length;a<n;a++)(u=p[a])[0].pilot||(u[0]=this.addShip()),u[0].fromSerialized(f,u[1])}}return this.suppress_automatic_new_ship=!1,this.addShip()}select_xws_view(){if(this.select_xws_view_button.blur(),"xws"!==this.list_display_mode)return this.list_modal.find(".list-display-mode .btn").removeClass("btn-inverse"),this.select_xws_view_button.addClass("btn-inverse"),this.list_display_mode="xws",this.xws_container.show(),this.simple_container.hide(),this.simplecopy_container.hide(),this.reddit_container.hide(),this.fancy_container.hide(),this.tts_container.hide(),this.xws_textarea.select(),this.xws_textarea.focus(),this.toggle_vertical_space_container.hide(),this.toggle_color_print_container.hide(),this.toggle_color_skip_text.hide(),this.toggle_maneuver_dial_container.hide(),this.toggle_expanded_shield_hull_container.hide(),this.toggle_qrcode_container.hide(),this.toggle_obstacle_container.hide(),this.btn_print_list.disabled=!0}uniqueIndex(t,i){if(i in this.uniques_in_use)return this.uniques_in_use[i].indexOf(t);throw new Error(`Invalid unique type '${i}'`)}claimUnique(t,i,e){var a,s,n,l,o,r,d;if(!(this.uniqueIndex(t,i)<0))throw new Error(`Unique ${i} '${t.name}' already claimed`);for(a=0,n=(r=exportObj.pilotsByUniqueName[t.canonical_name.getXWSBaseName()]||[]).length;a<n;a++)if(t!==(o=r[a])){if(!(this.uniqueIndex(o,"Pilot")<0))throw new Error(`Unique ${i} '${t.name}' already claimed as pilot`);this.uniques_in_use.Pilot.push(o)}for(s=0,l=(d=exportObj.upgradesByUniqueName[t.canonical_name.getXWSBaseName()]||[]).length;s<l;s++){if(o=d[s],!(this.uniqueIndex(o,"Upgrade")<0))throw new Error(`Unique ${i} '${o.name}' already claimed as pilot`);this.uniques_in_use.Upgrade.push(o)}return null!=t.solitary&&this.uniques_in_use.Slot.push(t.slot),this.uniques_in_use[i].push(t),e()}releaseUnique(t,i,e){var a,s,n,l,o,r,d;if(!(0<=this.uniqueIndex(t,i)))throw new Error(`Unique ${i} '${t.name}' not in use`);for(i in o=this.uniques_in_use)if(d=o[i],"Slot"===i){if(null!=t.solitary)for(this.uniques_in_use[i]=[],a=0,n=d.length;a<n;a++)(r=d[a])!==t.slot&&this.uniques_in_use[i].push(r.slot)}else for(this.uniques_in_use[i]=[],s=0,l=d.length;s<l;s++)(r=d[s]).canonical_name.getXWSBaseName()!==t.canonical_name.getXWSBaseName()&&this.uniques_in_use[i].push(r);return e()}addShip(){var t=new Ship({builder:this,container:this.ship_container});return this.ships.push(t),this.ship_number_invalid_container.toggleClass("d-none",this.ships.length<10&&3<this.ships.length),this.multi_faction_warning_container.toggleClass("d-none","All"!==this.faction),t}async removeShip(t,i=$.noop){return null!=(null!=t?t.destroy:void 0)&&(await t.destroy(defer()),await this.container.trigger("xwing:pointsUpdated",defer()),this.current_squad.dirty=!0,this.container.trigger("xwing-backend:squadDirtinessChanged"),this.ship_number_invalid_container.toggleClass("d-none",this.ships.length<10&&3<this.ships.length),this.multi_faction_warning_container.toggleClass("d-none","All"!==this.faction)),i()}matcher(t,i){return 0<=t.toUpperCase().indexOf(i.toUpperCase())}isOurFaction(t,i=""){var e,a,s,n=this.faction;if("All"===this.faction){if(""===i)return!0;n=i}if(t instanceof Array){for(a=0,s=t.length;a<s;a++)if(e=t[a],getPrimaryFaction(e)===n)return!0;return!1}return getPrimaryFaction(t)===n}isItemAvailable(t,i=!1){var e;return!!this.isQuickbuild||(this.isStandard?exportObj.standardCheck(t,this.faction,i):this.isEpic?!(null!=(null!=(e=exportObj.settings)?e.ban_list:void 0)&&exportObj.settings.ban_list&&!exportObj.standardCheck(t,this.faction,i,!0)):!(null!=(null!=(e=exportObj.settings)?e.ban_list:void 0)&&exportObj.settings.ban_list&&!exportObj.standardCheck(t,this.faction,i,!0))&&exportObj.epicExclusions(t))}getAvailableShipsMatching(t="",i=!0,e=!1){var a,s,n=[],l=exportObj.ships;for(s in l)a=l[s],this.isOurFaction(a.factions)&&(this.matcher(a.name,t)||a.display_name&&this.matcher(a.display_name,t))&&this.isItemAvailable(a,!0)&&(!e||null!=this.collection&&"true"===this.collection.checks.collectioncheck&&this.collection.checkShelf("ship",a.name))&&n.push({id:a.name,text:a.display_name||a.name,chassis:a.chassis,name:a.name,display_name:a.display_name,canonical_name:a.canonical_name,xws:a.name.canonicalize(),icon:a.icon||a.name.canonicalize()});return i&&n.sort(exportObj.sortHelper),n}getAvailableShipsMatchingAndCheapEnough(t,i="",e=!1,a=!1){for(var s,n,l=this.getAvailableShipsMatching(i,e,a),o=[],r=0,d=l.length;r<d;r++)n=l[r],(s=this.getAvailablePilotsForShipIncluding(n.name,null,"",!0)).length&&s[0].points<=t&&o.push(n);return o}getAvailablePilotsForShipIncluding(e,i,a="",t=!0,l=null){var o,s,n,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w,y,$,q,O,S,j,T=[];if(this.isQuickbuild){if(k=function(){var t=exportObj.quickbuildsById,i=[];for(r in t)x=t[r],(null==e||x.ship===e)&&this.isOurFaction(x.faction)&&(this.matcher(x.pilot,a)||null!=exportObj.pilots[x.pilot].display_name&&this.matcher(exportObj.pilots[x.pilot].display_name,a))&&i.push(x);return i}.call(this),O=[],null!=i&&-1!==i){if(d=exportObj.quickbuildsById[i],null!=(y=exportObj.pilots[d.pilot]).unique)for(O.push(y),u=0,p=(w=exportObj.pilotsByUniqueName[y.canonical_name.getXWSBaseName()]||[]).length;u<p;u++)null!=(_=w[u])&&O.push(_);for(h=0,f=($=null!=(y=d.upgrades)?y:[]).length;h<f;h++){if(c=$[h],null!=(c=exportObj.upgrades[c]).unique)for(O.push(_),b=0,m=(q=exportObj.pilotsByUniqueName[c.canonical_name.getXWSBaseName()]||[]).length;b<m;b++)null!=(_=q[b])&&O.push(_);null!=c.solitary&&O.push(c.slot)}}o=[],function(){var t,i=[];for(r in k)x=k[r],null!=(null!=(t=exportObj.pilots[x.pilot])?t.unique:void 0)&&(t=exportObj.pilots[x.pilot],0<=indexOf.call(this.uniques_in_use.Pilot,t))&&(t=exportObj.pilots[x.pilot],!(0<=indexOf.call(O,t)))||null!=(null!=(t=exportObj.pilots[x.pilot])?t.max_per_squad:void 0)&&this.countPilots(exportObj.pilots[x.pilot].canonical_name)>=exportObj.pilots[x.pilot].max_per_squad&&(t=exportObj.pilots[x.pilot],!(0<=indexOf.call(O,t)))?o.push(x.id):i.push(null!=x.upgrades?function(){for(var t,i,e=x.upgrades,a=[],s=0,n=e.length;s<n;s++)if(S=e[s],null==(j=exportObj.upgrades[S]))console.log("There was an Issue including the upgrade "+S+" in some quickbuild. Please report that Issue!");else{if(null!=j.unique&&0<=indexOf.call(this.uniques_in_use.Upgrade,j)&&!(0<=indexOf.call(O,j))&&(null===l||!(0<=indexOf.call(exportObj.quickbuildsById[l.quickbuildId].upgrades,S)||l.linkedShip&&0<=indexOf.call(null!=(t=exportObj.quickbuildsById[null!=(t=l.linkedShip)?t.quickbuildId:void 0].upgrades)?t:[],S)))){o.push(x.id);break}if(null!=j.solitary&&(t=j.slot,0<=indexOf.call(this.uniques_in_use.Slot,t))&&(i=j.slot,!(0<=indexOf.call(O,i)))){o.push(x.id);break}a.push(void 0)}return a}.call(this):void 0);return i}.call(this),T=(()=>{for(var t,i=[],e=0,a=k.length;e<a;e++)x=k[e],i.push({id:x.id,text:(null!=(null!=(t=exportObj.settings)?t.initiative_prefix:void 0)&&exportObj.settings.initiative_prefix?exportObj.pilots[x.pilot].skill+" - ":"")+(exportObj.pilots[x.pilot].display_name||x.pilot)+x.suffix+` (${x.threat})`,points:x.threat,ship:x.ship,disabled:(t=x.id,0<=indexOf.call(o,t))});return i})()}else s=function(){var t=exportObj.pilots,i=[];for(v in t)g=t[v],(null==e||g.ship===e)&&this.isOurFaction(g.faction)&&(this.matcher(v,a)||g.display_name&&this.matcher(g.display_name,a))&&this.isItemAvailable(g,!0)&&i.push(g);return i}.call(this),n=function(){var t=[];for(v in s)(null==(g=s[v]).unique||indexOf.call(this.uniques_in_use.Pilot,g)<0||g.canonical_name.getXWSBaseName()===(null!=i?i.canonical_name.getXWSBaseName():void 0))&&(null==g.max_per_squad||this.countPilots(g.canonical_name)<g.max_per_squad||g.canonical_name.getXWSBaseName()===(null!=i?i.canonical_name.getXWSBaseName():void 0))&&(null==g.upgrades||this.standard_restriction_check(g,i))&&(null==g.restriction_func||g.restriction_func({builder:this},g))&&t.push(g);return t}.call(this),null!=i&&null!=i.unique&&(this.matcher(i.name,a)||i.display_name&&this.matcher(i.display_name,a))&&n.push(i),T=function(){for(var t,i=[],e=0,a=s.length;e<a;e++)g=s[e],i.push({id:g.id,text:`${null!=(null!=(t=exportObj.settings)?t.initiative_prefix:void 0)&&exportObj.settings.initiative_prefix?g.skill+" - ":""}${g.display_name||g.name} (${this.isBeta&&null!=g.pointsbeta?g.pointsbeta:g.points}${null!=g.loadout?this.isBeta&&null!=g.loadoutbeta?"/"+g.loadoutbeta:"/"+g.loadout:""})`,points:this.isBeta&&null!=g.pointsbeta?g.pointsbeta:g.points,ship:g.ship,name:g.name,display_name:g.display_name,disabled:indexOf.call(n,g)<0});return i}.call(this);return T=t?T.sort(exportObj.sortHelper):T}standard_restriction_check(t,i){var e,a,s,n,l,o,r,d,c,u,h,p,f,m;if(null!=t.upgrades)for(e=0,s=(r=t.upgrades).length;e<s;e++)if(f=r[e],null!=(m=exportObj.upgrades[f]).unique)for(a=0,n=(d=this.ships).length;a<n;a++)if(null==(null!=(c=(h=d[a]).pilot)?c.name:void 0)||null==(null!=i?i.name:void 0)||h.pilot.name!==i.name)for(o=0,l=(u=h.upgrades).length;o<l;o++)if((null!=(p=u[o])&&null!=(p=p.data)?p.canonical_name:void 0)===m.canonical_name)return!1;return!0}countUpgrades(t){for(var i,e,a,s,n,l,o=0,r=this.ships,d=0,c=r.length;d<c;d++)if(null==(null!=(a=(n=r[d]).pilot)?a.upgrades:void 0))for(i=0,e=(s=n.upgrades).length;i<e;i++)(null!=(l=s[i])&&null!=(l=l.data)?l.canonical_name:void 0)===t&&o++;return o}countPilots(t){for(var i,e=0,a=this.ships,s=0,n=a.length;s<n;s++)(null!=(i=a[s])&&null!=(i=i.pilot)?i.canonical_name.getXWSBaseName():void 0)===t.getXWSBaseName()&&e++;return e}isShip(t,i){var e,a;if(t instanceof Array){for(e=0,a=t.length;e<a;e++)if(t[e]===i)return!0;return!1}return t===i}getAvailableUpgradesIncluding(e,a,s,n,l="",o=this.dfl_filter_func,t=!0){var r,i,d,c,u,h,p,f,m,b,_,g,v=(()=>{for(var t=s.upgrades,i=[],e=0,a=t.length;e<a;e++)_=t[e],i.push(_.data);return i})(),x=function(){var t=exportObj.upgrades,i=[];for(g in t)_=t[g],exportObj.slotsMatching(_.slot,e)&&(this.matcher(g,l)||_.display_name&&this.matcher(_.display_name,l))&&(null==_.ship||this.isShip(_.ship,s.data.name))&&(null==_.faction||this.isOurFaction(_.faction,s.pilot.faction))&&this.isItemAvailable(_)&&null==_.standard&&i.push(_);return i}.call(this);for(o!==this.dfl_filter_func&&(x=(()=>{for(var t=[],i=0,e=x.length;i<e;i++)_=x[i],o(_)&&t.push(_);return t})()),p=s.upgrade_points_total-n.getPoints(a),r=function(){var t,i=[];for(g in x)_=x[g],indexOf.call(this.uniques_in_use.Upgrade,_)<0&&s.standardized_check(_)&&s.restriction_check(s.builder.isBeta&&null!=_.restrictionsbeta?_.restrictionsbeta:_.restrictions||void 0,n,n.getPoints(_),p,_)&&indexOf.call(v,_)<0&&(null==_.max_per_squad||s.builder.countUpgrades(_.canonical_name)<_.max_per_squad)&&(null==_.solitary||(t=_.slot,indexOf.call(this.uniques_in_use.Slot,t)<0)||null!=(null!=a?a.solitary:void 0))&&i.push(_);return i}.call(this),d=0,u=(f=(()=>{for(var t=s.upgrades,i=[],e=0,a=t.length;e<a;e++)null!=(null!=(_=t[e])?_.data:void 0)&&i.push(_.data);return i})()).length;d<u;d++)i=f[d],r.removeItem(i);if(null!=a&&(this.matcher(a.name,l)||a.display_name&&this.matcher(a.display_name,l))&&r.push(a),b=(()=>{for(var t=[],i=0,e=x.length;i<e;i++)_=x[i],t.push({id:_.id,text:`${_.display_name||_.name} (${n.getPoints(_)}${_.variablepoints?"*":""})`,points:n.getPoints(_),name:_.name,display_name:_.display_name,disabled:indexOf.call(r,_)<0});return t})(),t&&(b=b.sort(exportObj.sortHelper)),"function"==typeof n&&n("undefined"!=typeof adjustment_func&&null!==adjustment_func)){for(m=[],c=0,h=b.length;c<h;c++)_=b[c],m.push(n.adjustment_func(_));return m}return b}getSquadDialsAsHTML(){for(var t,i,e,a,s="",n={},l=this.ships,o=0,r=l.length;o<r;o++)null!=(a=l[o]).pilot&&(i=a.data.maneuvers,t=a.effectiveStats().maneuvers,null!=n[a.data.name]&&(e=t.toString(),0<=indexOf.call(n[a.data.name],e))||(n[a.data.name]=(null!=(e=n[a.data.name])?e:[]).concat([t.toString()]),s+='<div class="fancy-dial"><h4 class="ship-name-dial">'+(null!=a.data.display_name?a.data.display_name:a.data.name)+`${t.toString()!==i.toString()?" ("+this.uitranslation("modified")+")":""}</h4>`+this.getManeuverTableHTML(t,i)+"</div>"));return`<div class="print-dials-container">
    ${s}
</div>`}getManeuverTableHTML(a,t){var i,e,s,n,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w,y,q,O,S,j,T;if(null==a||0===a.length)return this.uitranslation("Missing maneuver info.");for(s=function(){for(var t=[],i=0,e=a[0].length;0<=e?i<e:e<i;0<=e?i++:i--)t.push(i);return t}.apply(this),d=0,u=a.length;d<u;d++)for(i=c=0,h=(e=a[d]).length;c<h;i=++c)0<e[i]&&s.removeItem(i);for(v="<table><tbody>",O=m=w=a.length-1;w<=0?m<=0:0<=m;O=w<=0?++m:--m){for(o=!1,g=0,p=(y=a[O]).length;g<p;g++)if(0<y[g]){o=!0;break}if(o){for(v+=`<tr><td>${O}</td>`,T=k=0,q=a[O].length;0<=q?k<q:q<k;T=0<=q?++k:--k)if(!(0<=indexOf.call(s,T))){if(v+="<td>",0<a[O][T]){if(l=(()=>{switch(a[O][T]){case 1:return"dodgerblue";case 2:return"white";case 3:return"red";case 4:return"purple"}})(),b=(()=>{switch(a[O][T]){case 1:return"svg-blue-maneuver";case 2:return"svg-white-maneuver";case 3:return"svg-red-maneuver";case 4:return"svg-purple-maneuver"}})(),v+='<svg xmlns="http://www.w3.org/2000/svg" width="30px" height="30px" viewBox="0 0 200 200">',x="black",_="svg-base-maneuver",a[O][T]!==t[O][T]&&(x="DarkSlateGrey",_="svg-modified-maneuver"),0===O&&2===T)v+=`<rect class="svg-maneuver-stop ${b} ${_}" x="50" y="50" width="100" height="100" style="fill:${l}; stroke-width:5; stroke:${x}" />`;else{switch(n=S="",T){case 0:f="M160,180 L160,70 80,70",r="M160,175 L160,70 70,70",j="M80,100 V40 L30,70 Z";break;case 1:f="M150,180 S150,120 80,60",r="M150,175 S150,120 80,60",j="M80,100 V40 L30,70 Z",S="transform='translate(-5 -15) rotate(45 70 90)' ";break;case 2:f="M100,180 L100,100 100,80",r="M100,175 L100,120 100,70",j="M70,80 H130 L100,30 Z";break;case 3:f="M50,180 S50,120 120,60",r="M50,175 S50,120 120,60",j="M120,100 V40 L170,70 Z",S="transform='translate(5 -15) rotate(-45 130 90)' ";break;case 4:f="M40,180 L40,70 120,70",r="M40,175 L40,70 130,70",j="M120,100 V40 L170,70 Z";break;case 5:f="M50,180 L50,100 C50,10 140,10 140,100 L140,120",r="M50,175 L50,100 C50,10 140,10 140,100 L140,130",j="M170,120 H110 L140,180 Z";break;case 6:f="M150,180 S150,120 80,60",r="M150,175 S150,120 85,65",j="M80,100 V40 L30,70 Z",S="transform='translate(0 50)'";break;case 7:f="M50,180 S50,120 120,60",r="M50,175 S50,120 115,65",j="M120,100 V40 L170,70 Z",S="transform='translate(0 50)'";break;case 8:f="M160,180 L160,70 80,70",r="M160,175 L160,70 85,70",j="M60,100 H100 L80,140 Z";break;case 9:f="M40,180 L40,70 120,70",r="M40,175 L40,70 115,70",j="M100,100 H140 L120,140 Z";break;case 10:f="M50,180 S50,120 120,60",r="M50,175 S50,120 120,60",j="M120,100 V40 L170,70 Z",S="transform='translate(5 -15) rotate(-45 130 90)' ",n="backwards";break;case 11:f="M100,180 L100,100 100,80",r="M100,175 L100,100 100,70",j="M70,80 H130 L100,30 Z",n="backwards";break;case 12:f="M150,180 S150,120 80,60",r="M150,175 S150,120 80,60",j="M80,100 V40 L30,70 Z",S="transform='translate(-5 -15) rotate(45 70 90)' ",n="backwards"}v+=$.trim(`<g class="maneuver ${n}">
  <path class = 'svg-maneuver-outer ${b} ${_}' stroke-width='25' fill='none' stroke='${x}' d='${f}' />
  <path class = 'svg-maneuver-triangle ${b} ${_}' d='${j}' fill='${l}' stroke-width='5' stroke='${x}' ${S}/>
  <path class = 'svg-maneuver-inner ${b} ${_}' stroke-width='15' fill='none' stroke='${l}' d='${r}' />
</g>`)}v+="</svg>"}v+="</td>"}v+="</tr>"}}return v+="</tbody></table>"}formatActions(t,i,e=[]){for(var a,s,n,l=[],o=0,r=t.length;o<r;o++)a=t[o],s="",n=i,-1!==(a=0<=indexOf.call(e,"Droid")?a.replace("Focus","Calculate"):a).search("> ")&&(a=a.replace(/> /gi,""),n=' <i class="xwing-miniatures-font xwing-miniatures-font-linked"></i> '),-1!==a.search("F-")&&(s="force ",a=a.replace(/F-/gi,"")),-1!==a.search("W-")?(n="White ",a=a.replace(/W-/gi,"")):-1!==a.search("R-")&&(s="red ",a=a.replace(/R-/gi,"")),a=a.toLowerCase().replace(/[^0-9a-z]/gi,""),l.push(n+`<i class="xwing-miniatures-font ${s}xwing-miniatures-font-${a}"></i>`);return l.join("").replace(i,"")}listStandardUpgrades(t){for(var i="",e=0,a=t.length;e<a;e++)i+=", "+t[e].split(" (")[0];return i.substr(2)}getPilotsMatchingUpgrade(t="",i=!0){var e,a,s,n,l,o,r=[],d=exportObj.pilots;for(n in d)if(null!=(s=d[n]).upgrades)for(e=0,a=(l=s.upgrades).length;e<a;e++)o=l[e],this.matcher(o,t)&&r.push({id:s.name,name:s.name,display_name:s.display_name,chassis:s.chassis,canonical_name:s.canonical_name,xws:s.name.canonicalize(),icon:s.icon||s.name.canonicalize()});return i&&r.sort(exportObj.sortHelper),r}showTooltip(t,n,i,e=this.info_container,a=!1){var s,l,B,o,z,r,d,c,M,u,h,p,N,D,R,F,f,W,m,G,b,_,g,v,x,k,w,y,X,H,Q,V,q,O,S,j,T,C,L,I,A,U,P,E;if(n!==this.tooltip_currently_displaying||a){switch(t){case"Ship":for(C in k=[],x=[],w=[],L={},exportObj.upgradesBySlotCanonicalName)L[C]=-1;for(G in X=exportObj.pilots)if((_=X[G]).ship===n.name&&this.isOurFaction(_.faction)&&(H=_.skill,0<=indexOf.call(k,H)||k.push(_.skill),this.isBeta&&null!=_.pointsbeta?x.push(_.pointsbeta):x.push(_.points),this.isBeta&&null!=_.loadoutbeta?w.push(_.loadoutbeta):null!=_.loadout&&w.push(_.loadout),null!=_.slots))for(C in L)switch(U=L[C],_.slots.filter(t=>t===C).length){case 1:switch(U){case-1:L[C]=1;break;case 0:L[C]=2;break;case 3:L[C]=4}break;case 0:switch(U){case-1:L[C]=0;break;case 1:L[C]=2;break;case 3:case 4:L[C]=5}break;case 2:switch(U){case-1:L[C]=3;break;case 0:case 2:L[C]=5;break;case 1:L[C]=4}break;case 3:L[C]=6}for(k.sort(),e.find(".info-type").text(exportObj.translate("types",t)),e.find(".info-name").html(""+(n.display_name||n.name)+(exportObj.isReleased(n)?"":` (${this.uitranslation("unreleased")})`)),null!=(null!=(A=this.collection)?A.counts:void 0)?(T=null!=(A=null!=(A=this.collection.counts)&&null!=(A=A.ship)?A[n.name]:void 0)?A:0,e.find(".info-collection").text(this.uitranslation("collectionContentShips",T)),e.find(".info-collection").show()):e.find(".info-collection").hide(),r=!0,M=String(k[0]),h=0,N=k.length;h<N;h++)c=k[h],r||(M+=", "+c),r=!1;for(e.find("tr.info-skill td.info-data").text(M),e.find("tr.info-skill").toggle(void 0!==c),A=Math.min(...x)+" - "+Math.max(...x),e.find("tr.info-points td.info-data").text(A),A=Math.min(...w)+" - "+Math.max(...w),e.find("tr.info-loadout td.info-data").text(A),e.find("tr.info-points").toggle(0<x.length),e.find("tr.info-loadout").toggle(0<w.length),e.find("tr.info-engagement").hide(),e.find("tr.info-attack td.info-data").text(n.attack),e.find("tr.info-attack-bullseye td.info-data").text(n.attackbull),e.find("tr.info-attack-fullfront td.info-data").text(n.attackf),e.find("tr.info-attack-left td.info-data").text(n.attackl),e.find("tr.info-attack-right td.info-data").text(n.attackr),e.find("tr.info-attack-back td.info-data").text(n.attackb),e.find("tr.info-attack-turret td.info-data").text(n.attackt),e.find("tr.info-attack-doubleturret td.info-data").text(n.attackdt),e.find("tr.info-attack").toggle(null!=n.attack),e.find("tr.info-attack-bullseye").toggle(null!=n.attackbull),e.find("tr.info-attack-fullfront").toggle(null!=n.attackf),e.find("tr.info-attack-left").toggle(null!=n.attackl),e.find("tr.info-attack-right").toggle(null!=n.attackr),e.find("tr.info-attack-back").toggle(null!=n.attackb),e.find("tr.info-attack-turret").toggle(null!=n.attackt),e.find("tr.info-attack-doubleturret").toggle(null!=n.attackdt),e.find("tr.info-ship").hide(),null!=n.base?e.find("tr.info-base td.info-data").text(exportObj.translate("gameterms",n.base)):e.find("tr.info-base td.info-data").text(exportObj.translate("gameterms","Small")),e.find("tr.info-base").show(),e.find("tr.info-faction td.info-data").text([(()=>{for(var t=n.factions,i=[],e=0,a=t.length;e<a;e++)z=t[e],i.push(exportObj.translate("faction",z));return i})()]),e.find("tr.info-faction").hide(),e.find("p.info-restrictions").hide(),p=0,D=(Q=e.find("tr.info-attack td.info-header i.xwing-miniatures-font")[0].classList).length;p<D;p++)(B=Q[p]).startsWith("xwing-miniatures-font-attack")&&e.find("tr.info-attack td.info-header i.xwing-miniatures-font").removeClass(B);if(e.find("tr.info-attack td.info-header i.xwing-miniatures-font").addClass(null!=(A=n.attack_icon)?A:"xwing-miniatures-font-attack"),e.find("tr.info-range").hide(),e.find("tr.info-agility td.info-data").text(n.agility),e.find("tr.info-agility").toggle(null!=n.agility),e.find("tr.info-hull td.info-data").text(n.hull),e.find("tr.info-hull").toggle(null!=n.hull),y="",null!=n.shieldrecurr)for(o=0;o<n.shieldrecurr;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;if(e.find("tr.info-shields td.info-data").html(n.shields+y),e.find("tr.info-shields").toggle(null!=n.shields),y="",null!=n.energyrecurr)for(o=0;o<n.energyrecurr;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;e.find("tr.info-energy td.info-data").html(n.energy+y),e.find("tr.info-energy").toggle(null!=n.energy),e.find("tr.info-force").hide(),e.find("tr.info-charge").hide(),e.find("tr.info-actions td.info-data").html(this.formatActions(n.actions,", ",null!=(A=n.keyword)?A:[])),e.find("tr.info-actions").show(),e.find("tr.info-upgrades").show(),e.find("tr.info-upgrades td.info-data").html((()=>{var t=[];for(C in L)U=L[C],t.push(1===U?exportObj.translate("sloticon",C):2===U?"("+exportObj.translate("sloticon",C)+")":3===U?exportObj.translate("sloticon",C)+exportObj.translate("sloticon",C):4===U?exportObj.translate("sloticon",C)+"("+exportObj.translate("sloticon",C)+")":5===U?"("+exportObj.translate("sloticon",C)+exportObj.translate("sloticon",C)+")":6===U?exportObj.translate("sloticon",C)+exportObj.translate("sloticon",C)+exportObj.translate("sloticon",C):void 0);return t})().join(" ")||"None"),e.find("p.info-text").hide(),e.find("p.info-chassis").show(),e.find("p.info-chassis").html(null!=n.chassis?`<strong>${null!=(A=null!=(A=exportObj.chassis[n.chassis])?A.display_name:void 0)?A:n.chassis}:</strong> `+exportObj.chassis[n.chassis].text:""),e.find("p.info-maneuvers").show(),e.find("p.info-maneuvers").html(this.getManeuverTableHTML(n.maneuvers,n.maneuvers)),A=(()=>{for(var t=n.sources,i=[],e=0,a=t.length;e<a;e++)I=t[e],i.push(exportObj.translate("sources",I));return i})().sort(),e.find(".info-sources.info-data").text(1<A.length||(O=exportObj.translate("sources","Loose Ships"),!(0<=indexOf.call(A,O)))?0<A.length?A.join(", "):exportObj.translate("ui","unreleased"):this.uitranslation("Only available from 1st edition")),e.find(".info-sources").show();break;case"Pilot":if(e.find(".info-type").text(exportObj.translate("types",t)),e.find(".info-sources.info-data").text((()=>{for(var t=n.sources,i=[],e=0,a=t.length;e<a;e++)I=t[e],i.push(exportObj.translate("sources",I));return i})().sort().join(", ")),e.find(".info-sources").show(),null!=(null!=(O=this.collection)?O.counts:void 0)?(O=null!=(A=null!=(A=this.collection.counts)&&null!=(O=A.pilot)?O[n.name]:void 0)?A:0,T=null!=(A=null!=(A=this.collection.counts.ship)?A[n.ship]:void 0)?A:0,e.find(".info-collection").text(this.uitranslation("collectionContentShipsAndPilots",T,O)),e.find(".info-collection").show()):e.find(".info-collection").hide(),null!=(null!=i?i.effectiveStats:void 0)&&(q=i.effectiveStats()),null!=n.unique)P="&middot;&nbsp;";else if(null!=n.max_per_squad){for(o=0,P="";o<n.max_per_squad;)P=P.concat("&middot;"),++o;P=P.concat("&nbsp;")}else P="";if(e.find(".info-name").html(""+P+(n.display_name||n.name)+(exportObj.isReleased(n)?"":` (${exportObj.translate("ui","unreleased")})`)),""!==(S=this.restriction_text(n)+this.upgrade_effect(n))&&"Conversion"!==n.ship?(e.find("p.info-restrictions").html(S),e.find("p.info-restrictions").show()):e.find("p.info-restrictions").hide(),e.find("p.info-text").html(null!=(A=n.text)?A:""),e.find("p.info-text").show(),j=exportObj.ships[n.ship],""!==(T=null!=(null!=q?q.chassis:void 0)&&""!==q.chassis?q.chassis:null!=n.chassis?n.chassis:null!=j.chassis?j.chassis:"")?(e.find("p.info-chassis").html(`<strong>${null!=(A=null!=(O=exportObj.chassis[T])?O.display_name:void 0)?A:T}:</strong> `+exportObj.chassis[T].text),e.find("p.info-chassis").show()):e.find("p.info-chassis").hide(),e.find("tr.info-ship td.info-data").text(n.ship),e.find("tr.info-ship").show(),e.find("tr.info-faction td.info-data").text(exportObj.translate("faction",n.faction)),e.find("tr.info-faction").hide(),null!=j.base?e.find("tr.info-base td.info-data").text(exportObj.translate("gameterms",j.base)):e.find("tr.info-base td.info-data").text(exportObj.translate("gameterms","Small")),e.find("tr.info-base").show(),e.find("tr.info-skill td.info-data").text(n.skill),e.find("tr.info-skill").toggle(null!=n.skill),e.find("tr.info-points td.info-data").text(this.isBeta&&null!=n.pointsbeta?n.pointsbeta:n.points),e.find("tr.info-points").show(),e.find("tr.info-loadout td.info-data").text(this.isBeta&&null!=n.loadoutbeta?n.loadoutbeta:n.loadout),null!=n.upgrades?e.find("tr.info-loadout").hide():e.find("tr.info-loadout").show(),null!=n.engagement?(e.find("tr.info-engagement td.info-data").text(n.engagement),e.find("tr.info-engagement").show()):e.find("tr.info-engagement").hide(),e.find("tr.info-attack td.info-header i.xwing-miniatures-font").addClass(null!=(O=j.attack_icon)?O:"xwing-miniatures-font-attack"),e.find("tr.info-attack td.info-data").text(statAndEffectiveStat(null!=(T=null!=(A=n.ship_override)?A.attack:void 0)?T:j.attack,q,"attack")),e.find("tr.info-attack").toggle(0<(null!=(A=null!=(O=n.ship_override)?O.attack:void 0)?A:j.attack)||null!=(null!=q?q.attack:void 0)&&0<(null!=q?q.attack:void 0)),e.find("tr.info-attack-fullfront td.info-data").text(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.attackf:void 0)?O:j.attackf,q,"attackf")),e.find("tr.info-attack-fullfront").toggle(null!=j.attackf||null!=(null!=q?q.attackf:void 0)),e.find("tr.info-attack-bullseye td.info-data").text(statAndEffectiveStat(null!=(T=null!=(A=n.ship_override)?A.attackbull:void 0)?T:j.attackbull,q,"attackbull")),e.find("tr.info-attack-bullseye").toggle(null!=j.attackbull||null!=(null!=q?q.attackbull:void 0)),e.find("tr.info-attack-left td.info-data").text(statAndEffectiveStat(null!=(A=null!=(O=n.ship_override)?O.attackl:void 0)?A:j.attackl,q,"attackl")),e.find("tr.info-attack-left").toggle(null!=j.attackl||null!=(null!=q?q.attackl:void 0)),e.find("tr.info-attack-right td.info-data").text(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.attackr:void 0)?O:j.attackr,q,"attackr")),e.find("tr.info-attack-right").toggle(null!=j.attackr||null!=(null!=q?q.attackr:void 0)),e.find("tr.info-attack-back td.info-data").text(statAndEffectiveStat(null!=(T=null!=(A=n.ship_override)?A.attackb:void 0)?T:j.attackb,q,"attackb")),e.find("tr.info-attack-back").toggle(null!=j.attackb||null!=(null!=q?q.attackb:void 0)),e.find("tr.info-attack-turret td.info-data").text(statAndEffectiveStat(null!=(A=null!=(O=n.ship_override)?O.attackt:void 0)?A:j.attackt,q,"attackt")),e.find("tr.info-attack-turret").toggle(null!=(null!=(T=n.ship_override)?T.attackt:void 0)||null!=j.attackt||null!=(null!=q?q.attackt:void 0)),e.find("tr.info-attack-doubleturret td.info-data").text(statAndEffectiveStat(null!=(A=null!=(O=n.ship_override)?O.attackdt:void 0)?A:j.attackdt,q,"attackdt")),e.find("tr.info-attack-doubleturret").toggle(null!=j.attackdt||null!=(null!=q?q.attackdt:void 0)),e.find("tr.info-range").hide(),e.find("td.info-rangebonus").hide(),e.find("tr.info-agility td.info-data").text(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.agility:void 0)?O:j.agility,q,"agility")),e.find("tr.info-agility").toggle(null!=(null!=(A=n.ship_override)?A.agility:void 0)||null!=j.agility),e.find("tr.info-hull td.info-data").text(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.hull:void 0)?O:j.hull,q,"hull")),e.find("tr.info-hull").toggle(null!=(null!=(A=n.ship_override)?A.hull:void 0)||null!=j.hull),y="",null!=j.shieldrecurr)for(o=0;o<j.shieldrecurr;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;if(e.find("tr.info-shields td.info-data").html(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.shields:void 0)?O:j.shields,q,"shields")+y),e.find("tr.info-shields").toggle(null!=(null!=(A=n.ship_override)?A.shields:void 0)||null!=j.shields),y="",null!=j.energyrecurr)for(o=0;o<j.energyrecurr;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;if(e.find("tr.info-energy td.info-data").html(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.energy:void 0)?O:j.energy,q,"energy")+y),e.find("tr.info-energy").toggle(null!=(null!=(A=n.ship_override)?A.energy:void 0)||null!=j.energy),null!=(null!=q?q.force:void 0)&&0<q.force||null!=n.force){for(y="",d=1,null!=(null!=q?q.forcerecurring:void 0)?d=q.forcerecurring:null!=n.forcerecurring&&(d=n.forcerecurring),o=0;o<d;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;e.find("tr.info-force td.info-data").html(statAndEffectiveStat(null!=(O=null!=(T=n.ship_override)?T.force:void 0)?O:n.force,q,"force")+y),e.find("tr.info-force").show()}else e.find("tr.info-force").hide();if(null!=n.charge){if(y="",null!=n.recurring)if(0<n.recurring)for(o=0;o<n.recurring;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;else for(o=n.recurring;o<0;)y+='<sub><i class="fas fa-caret-down"></i></sub>',++o;l=$.trim(""+n.charge+y),e.find("tr.info-charge td.info-data").html(l),e.find("tr.info-charge").show()}else e.find("tr.info-charge").hide();null!=(null!=q?q.actions:void 0)?e.find("tr.info-actions td.info-data").html(this.formatActions(null!=(T=null!=(A=n.ship_override)?A.actions:void 0)?T:q.actions,", ")):e.find("tr.info-actions td.info-data").html(this.formatActions(null!=(A=null!=(O=n.ship_override)?O.actions:void 0)?A:j.actions,", ",null!=(T=n.keyword)?T:[])),e.find("tr.info-actions").show(),this.isQuickbuild?e.find("tr.info-upgrades").hide():(e.find("tr.info-upgrades").show(),this.isBeta&&null!=n.slotsbeta?e.find("tr.info-upgrades td.info-data").html(null!=n.slotsbeta?(()=>{for(var t=n.slotsbeta,i=[],e=0,a=t.length;e<a;e++)C=t[e],i.push(exportObj.translate("sloticon",C));return i})().join(" "):null!=n.upgrades?this.listStandardUpgrades(n.upgrades):"None"):e.find("tr.info-upgrades td.info-data").html(null!=n.slots?(()=>{for(var t=n.slots,i=[],e=0,a=t.length;e<a;e++)C=t[e],i.push(exportObj.translate("sloticon",C));return i})().join(" "):null!=n.upgrades?this.listStandardUpgrades(n.upgrades):"None")),e.find("p.info-maneuvers").show(),e.find("p.info-maneuvers").html(this.getManeuverTableHTML(null!=(O=null!=q?q.maneuvers:void 0)?O:j.maneuvers,j.maneuvers));break;case"Quickbuild":if(e.find(".info-type").text(this.uitranslation("Quickbuild")),e.find(".info-sources").hide(),e.find(".info-collection").hide(),_=exportObj.pilots[n.pilot],j=exportObj.ships[n.ship],null!=_.unique)P="&middot;&nbsp;";else if(null!=_.max_per_squad){for(o=0,P="";o<n.max_per_squad;)P=P.concat("&middot;"),++o;P=P.concat("&nbsp;")}else P="";if(e.find(".info-name").html(""+P+(_.display_name||_.name)+(null!=n.suffix?n.suffix:"")+(exportObj.isReleased(_)?"":` (${exportObj.translate("ui","unreleased")})`)),""!==(S=this.restriction_text(n)+this.upgrade_effect(n))?(e.find("p.info-restrictions").html(null!=S?S:""),e.find("p.info-restrictions").show()):e.find("p.info-restrictions").hide(),e.find("p.info-text").html(null!=(A=_.text)?A:""),e.find("p.info-text").show(),e.find("p.info-chassis").html(null!=_.chassis?`<strong>${null!=(O=null!=(T=exportObj.chassis[_.chassis])?T.display_name:void 0)?O:_.chassis}:</strong> `+exportObj.chassis[_.chassis].text:null!=j.chassis?`<strong>${j.chassis}:</strong> `+exportObj.chassis[j.chassis].text:""),e.find("p.info-chassis").show(),e.find("tr.info-ship td.info-data").text(n.ship),e.find("tr.info-ship").show(),e.find("tr.info-faction td.info-data").text(exportObj.translate("faction",n.faction)),e.find("tr.info-faction").hide(),null!=j.base?e.find("tr.info-base td.info-data").text(exportObj.translate("gameterms",j.base)):e.find("tr.info-base td.info-data").text(exportObj.translate("gameterms","Small")),e.find("tr.info-base").show(),e.find("tr.info-skill td.info-data").text(_.skill),e.find("tr.info-skill").show(),e.find("tr.info-points").hide(),e.find("tr.info-loadout").hide(),e.find("tr.info-engagement td.info-data").text(_.skill),e.find("tr.info-engagement").show(),e.find("tr.info-attack td.info-data").text(null!=(T=null!=(A=_.ship_override)?A.attack:void 0)?T:j.attack),e.find("tr.info-attack").toggle(0<(null!=(A=null!=(O=_.data.ship_override)?O.attack:void 0)?A:j.attack)),e.find("tr.info-attack-fullfront td.info-data").text(j.attackf),e.find("tr.info-attack-fullfront").toggle(null!=j.attackf),e.find("tr.info-attack-bullseye td.info-data").text(j.attackbull),e.find("tr.info-attack-bullseye").toggle(null!=j.attackbull),e.find("tr.info-attack-left td.info-data").text(j.attackl),e.find("tr.info-attack-left").toggle(null!=j.attackl),e.find("tr.info-attack-right td.info-data").text(j.attackr),e.find("tr.info-attack-right").toggle(null!=j.attackr),e.find("tr.info-attack-back td.info-data").text(j.attackb),e.find("tr.info-attack-back").toggle(null!=j.attackb),e.find("tr.info-attack-turret td.info-data").text(j.attackt),e.find("tr.info-attack-turret").toggle(null!=j.attackt),e.find("tr.info-attack-doubleturret td.info-data").text(j.attackdt),e.find("tr.info-attack-doubleturret").toggle(null!=j.attackdt),e.find("tr.info-attack td.info-header i.xwing-miniatures-font").addClass(null!=(T=j.attack_icon)?T:"xwing-miniatures-font-frontarc"),e.find("tr.info-energy td.info-data").text(null!=(A=null!=(O=_.ship_override)?O.energy:void 0)?A:j.energy),e.find("tr.info-energy").toggle(null!=(null!=(T=_.ship_override)?T.energy:void 0)||null!=j.energy),e.find("tr.info-range").hide(),e.find("td.info-rangebonus").hide(),e.find("tr.info-agility td.info-data").text(null!=(A=null!=(O=_.ship_override)?O.agility:void 0)?A:j.agility),e.find("tr.info-agility").show(),e.find("tr.info-hull td.info-data").text(null!=(O=null!=(T=_.ship_override)?T.hull:void 0)?O:j.hull),e.find("tr.info-hull").show(),e.find("tr.info-shields td.info-data").text(null!=(T=null!=(A=_.ship_override)?A.shields:void 0)?T:j.shields),e.find("tr.info-shields").show(),null!=(null!=q?q.force:void 0)||null!=n.force){for(y="",d=1,null!=(null!=q?q.forcerecurring:void 0)&&(d=q.forcerecurring),o=0;o<d;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;e.find("tr.info-force td.info-data").html((null!=(A=null!=(O=_.ship_override)?O.force:void 0)?A:_.force)+y),e.find("tr.info-force").show()}else e.find("tr.info-force").hide();if(null!=n.charge){if(y="",null!=n.recurring)if(0<n.recurring)for(o=0;o<n.recurring;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;else for(o=n.recurring;o<0;)y+='<sub><i class="fas fa-caret-down"></i></sub>',++o;l=$.trim(""+n.charge+y),e.find("tr.info-charge td.info-data").html(l),e.find("tr.info-charge").show()}else e.find("tr.info-charge").hide();e.find("tr.info-actions td.info-data").html(this.formatActions(null!=(q=null!=(T=_.ship_override)?T.actions:void 0)?q:exportObj.ships[n.ship].actions,", ",null!=(O=_.keyword)?O:[])),e.find("tr.info-actions").show(),e.find("tr.info-upgrades").show(),e.find("tr.info-upgrades td.info-data").html((()=>{for(var t,i=null!=(t=n.upgrades)?t:[],e=[],a=0,s=i.length;a<s;a++)E=i[a],e.push(null!=exportObj.upgrades[E].display_name?exportObj.upgrades[E].display_name:E);return e})().join(", ")||"None"),e.find("p.info-maneuvers").show(),e.find("p.info-maneuvers").html(this.getManeuverTableHTML(j.maneuvers,j.maneuvers));break;case"Addon":if(e.find(".info-type").text(exportObj.translate("slot",i.addon_type)),null!=n.standard?(W=this.getPilotsMatchingUpgrade(n.name,!1),e.find(".info-sources.info-data").text((()=>{for(var t=[],i=0,e=W.length;i<e;i++)_=W[i],t.push(_.display_name);return t})().sort().join(", "))):e.find(".info-sources.info-data").text((()=>{for(var t=n.sources,i=[],e=0,a=t.length;e<a;e++)I=t[e],i.push(exportObj.translate("sources",I));return i})().sort().join(", ")),e.find(".info-sources").show(),null!=n.unique)P="&middot;&nbsp;";else if(null!=n.max_per_squad){for(o=0,P="";o<n.max_per_squad;)P=P.concat("&middot;"),++o;P=P.concat("&nbsp;")}else P="";if(null!=(null!=(A=this.collection)?A.counts:void 0)&&null==n.standard?(s=null!=(O=null!=(T=this.collection.counts)&&null!=(q=T.upgrade)?q[n.name]:void 0)?O:0,e.find(".info-collection").text(this.uitranslation("collectionContentUpgrades",s)),e.find(".info-collection").show()):e.find(".info-collection").hide(),e.find(".info-name").html(""+P+(n.display_name||n.name)+(exportObj.isReleased(n)||null!=n.standard?"":` (${this.uitranslation("unreleased")})`)+(null!=n.standard?" (S)":"")),v=this.isBeta&&null!=n.pointsbeta?n.pointsbeta:n.points,Array.isArray(v)){switch(g="<i>"+this.uitranslation("varPointCostsPoints",v),n.variablepoints){case"Agility":g+=this.uitranslation("varPointCostsConditionAgility",function(){for(var t=[],i=0,e=v.length-1;0<=e?i<=e:e<=i;0<=e?i++:i--)t.push(i);return t}.apply(this));break;case"Initiative":g+=this.uitranslation("varPointCostsConditionIni",function(){for(var t=[],i=0,e=v.length-1;0<=e?i<=e:e<=i;0<=e?i++:i--)t.push(i);return t}.apply(this));break;case"Base":g+=this.uitranslation("varPointCostsConditionBase");break;case"Faction":g+=this.uitranslation("varPointCostsConditionFaction",n.faction)}g+="</i>"}if(S=this.restriction_text(n)+this.upgrade_effect(n),null!=g||""!==S?(null!=g&&""!==S&&(g+="<br/>"),e.find("p.info-restrictions").html((null!=g?g:"")+S),e.find("p.info-restrictions").show()):e.find("p.info-restrictions").hide(),e.find("p.info-text").html(null!=(A=n.text)?A:""),e.find("p.info-text").show(),e.find("p.info-chassis").hide(),e.find("tr.info-ship").hide(),e.find("tr.info-faction").hide(),e.find("tr.info-base").hide(),e.find("tr.info-skill").hide(),e.find("tr.info-points").hide(),e.find("tr.info-loadout").hide(),e.find("tr.info-engagement").hide(),null!=n.energy?(e.find("tr.info-energy td.info-data").text(n.energy),e.find("tr.info-energy").show()):e.find("tr.info-energy").hide(),null!=n.attack?(e.find("tr.info-attack td.info-data").text(n.attack),e.find("tr.info-attack").show()):e.find("tr.info-attack").hide(),null!=n.attackb?(e.find("tr.info-attack-back td.info-data").text(n.attackb),e.find("tr.info-attack-back").show()):e.find("tr.info-attack-back").hide(),null!=n.attackt?(e.find("tr.info-attack-turret td.info-data").text(n.attackt),e.find("tr.info-attack-turret").show()):e.find("tr.info-attack-turret").hide(),null!=n.attackr?(e.find("tr.info-attack-right td.info-data").text(n.attackr),e.find("tr.info-attack-right").show()):e.find("tr.info-attack-right").hide(),null!=n.attackl?(e.find("tr.info-attack-left td.info-data").text(n.attackl),e.find("tr.info-attack-left").show()):e.find("tr.info-attack-left").hide(),null!=n.attackdt?(e.find("tr.info-attack-doubleturret td.info-data").text(n.attackdt),e.find("tr.info-attack-doubleturret").show()):e.find("tr.info-attack-doubleturret").hide(),null!=n.attackbull?(e.find("tr.info-attack-bullseye td.info-data").text(n.attackbull),e.find("tr.info-attack-bullseye").show()):e.find("tr.info-attack-bullseye").hide(),null!=n.attackf?(e.find("tr.info-attack-fullfront td.info-data").text(n.attackf),e.find("tr.info-attack-fullfront").show()):e.find("tr.info-attack-fullfront").hide(),null!=n.charge){if(y="",null!=n.recurring)if(0<n.recurring)for(o=0;o<n.recurring;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;else for(o=n.recurring;o<0;)y+='<sub><i class="fas fa-caret-down"></i></sub>',++o;l=$.trim(""+n.charge+y),e.find("tr.info-charge td.info-data").html(l)}if(e.find("tr.info-charge").toggle(null!=n.charge),null!=n.range?(e.find("tr.info-range td.info-data").text(n.range),e.find("tr.info-range").show()):e.find("tr.info-range").hide(),null!=n.rangebonus?e.find("td.info-rangebonus").show():e.find("td.info-rangebonus").hide(),null!=n.force){for(y="",d=1,null!=n.forcerecurring&&(d=n.forcerecurring),o=0;o<d;)y+='<sup><i class="fas fa-caret-up"></i></sup>',++o;e.find("tr.info-force td.info-data").html(n.force+y)}e.find("tr.info-force").toggle(null!=n.force),e.find("tr.info-agility").hide(),e.find("tr.info-hull").hide(),e.find("tr.info-shields").hide(),e.find("tr.info-actions").hide(),e.find("tr.info-upgrades").hide(),e.find("p.info-maneuvers").hide();break;case"Rules":e.find(".info-type").hide(),e.find(".info-sources").hide(),e.find(".info-collection").hide(),e.find(".info-name").html(n.name),e.find(".info-name").show(),e.find("p.info-restrictions").hide(),e.find("p.info-text").html(n.text),e.find("p.info-text").show(),e.find("tr.info-ship").hide(),e.find("tr.info-faction").hide(),e.find("tr.info-base").hide(),e.find("tr.info-skill").hide(),e.find("tr.info-points").hide(),e.find("tr.info-loadout").hide(),e.find("tr.info-agility").hide(),e.find("tr.info-hull").hide(),e.find("tr.info-shields").hide(),e.find("tr.info-actions").hide(),e.find("tr.info-upgrades").hide(),e.find("p.info-maneuvers").hide(),e.find("tr.info-energy").hide(),e.find("tr.info-attack").hide(),e.find("tr.info-attack-turret").hide(),e.find("tr.info-attack-bullseye").hide(),e.find("tr.info-attack-fullfront").hide(),e.find("tr.info-attack-back").hide(),e.find("tr.info-attack-doubleturret").hide(),e.find("tr.info-charge").hide(),e.find("td.info-rangebonus").hide(),e.find("tr.info-range").hide(),e.find("tr.info-force").hide();break;case"MissingStuff":for(e.find(".info-type").text(this.uitranslation("List of Missing items")),e.find(".info-sources").hide(),e.find(".info-collection").hide(),e.find(".info-name").html(this.uitranslation("Missing items")),e.find(".info-name").show(),m=this.uitranslation("Missing Item List:")+"<ul>",f=0,R=n.length;f<R;f++){for(m+=`<li><strong>${null!=(u=n[f]).display_name?u.display_name:u.name}</strong> (`,r=!0,b=0,F=(V=u.sources).length;b<F;b++)r||(m+=", "),m+=I=V[b],r=!1;m+=")</li>"}m+="</ul>",e.find("p.info-restrictions").hide(),e.find("p.info-text").html(m),e.find("p.info-text").show(),e.find("tr.info-ship").hide(),e.find("tr.info-faction").hide(),e.find("tr.info-base").hide(),e.find("tr.info-skill").hide(),e.find("tr.info-points").hide(),e.find("tr.info-loadout").hide(),e.find("tr.info-agility").hide(),e.find("tr.info-hull").hide(),e.find("tr.info-shields").hide(),e.find("tr.info-actions").hide(),e.find("tr.info-upgrades").hide(),e.find("p.info-maneuvers").hide(),e.find("tr.info-energy").hide(),e.find("tr.info-attack").hide(),e.find("tr.info-attack-turret").hide(),e.find("tr.info-attack-bullseye").hide(),e.find("tr.info-attack-fullfront").hide(),e.find("tr.info-attack-back").hide(),e.find("tr.info-attack-doubleturret").hide(),e.find("tr.info-charge").hide(),e.find("td.info-rangebonus").hide(),e.find("tr.info-range").hide(),e.find("tr.info-force").hide();break;case"Damage":e.find(".info-type").text(exportObj.translate("types",n.type)),e.find(".info-sources.info-data").text((()=>{for(var t=n.sources,i=[],e=0,a=t.length;e<a;e++)I=t[e],i.push(exportObj.translate("sources",I));return i})().sort().join(", ")),e.find(".info-sources").show(),null!=(null!=(T=this.collection)?T.counts:void 0)?(s=null!=(S=null!=(q=this.collection.counts)&&null!=(O=q.damage)?O[n.name]:void 0)?S:0,e.find(".info-collection").text(this.uitranslation("collectionContentUpgrades",s)),e.find(".info-collection").show()):e.find(".info-collection").hide(),e.find(".info-name").html(`${n.display_name||n.name} (${n.quantity}x)`),e.find("p.info-restrictions").hide(),e.find("p.info-text").html(null!=(A=n.text)?A:""),e.find("p.info-text").show(),e.find("p.info-chassis").hide(),e.find("tr.info-ship").hide(),e.find("tr.info-faction").hide(),e.find("tr.info-base").hide(),e.find("tr.info-skill").hide(),e.find("tr.info-points").hide(),e.find("tr.info-loadout").hide(),e.find("tr.info-engagement").hide(),e.find("tr.info-energy").hide(),e.find("tr.info-attack").hide(),e.find("tr.info-attack-back").hide(),e.find("tr.info-attack-turret").hide(),e.find("tr.info-attack-right").hide(),e.find("tr.info-attack-left").hide(),e.find("tr.info-attack-doubleturret").hide(),e.find("tr.info-attack-bullseye").hide(),e.find("tr.info-attack-fullfront").hide(),e.find("tr.info-charge").hide(),e.find("tr.info-range").hide(),e.find("td.info-rangebonus").hide(),e.find("tr.info-force").hide(),e.find("tr.info-agility").hide(),e.find("tr.info-hull").hide(),e.find("tr.info-shields").hide(),e.find("tr.info-actions").hide(),e.find("tr.info-upgrades").hide(),e.find("p.info-maneuvers").hide()}if(e!==this.mobile_tooltip_modal&&(e.find(".info-well").show(),e.find(".intro").hide()),this.tooltip_currently_displaying=n,768<=$(window).width())return a=e.find(".info-well"),$.isElementInView(a,!0)?a.css("position","fixed"):a.css("position","static")}}_randomizerLoopBody(s){var n,t,i,e,a,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w;if(s.keep_running){if(this.total_points===s.max_points){if(s.keep_running=!1,this.isQuickbuild)return void(s.keep_running=!1);for(e=0,l=(f=this.ships).length;e<l;e++)if(i=[],null!=(v=f[e]).pilot.loadout&&null==v.pilot.upgrades)for(;v.upgrade_points_total<v.pilot.loadout;){for(k=[],a=0,o=(m=v.upgrades).length;a<o;a++)null!=(w=m[a]).data||null!=w.occupied_by&&null!==w.occupied_by||0<=indexOf.call(i,w)||k.push(w);if(0===k.length)break;n=k[$.randomInt(k.length)],0<(t=function(){for(var t=this.getAvailableUpgradesIncluding(n.slot,null,v,n,"",this.dfl_filter_func,!1),i=[],e=0,a=t.length;e<a;e++)w=t[e],!exportObj.upgradesById[w.id].sources.intersects(s.allowed_sources)||s.collection_only&&!this.collection.checkShelf("upgrade",w.name)||w.disabled||i.push(w);return i}.call(this)).length?(w=t[$.randomInt(t.length)],n.setById(w.id)):i.push(n)}}else if(this.total_points<s.max_points){if(0<(x=0===(x=this.getAvailableShipsMatchingAndCheapEnough(s.max_points-this.total_points,"",!1,s.collection_only)).length?this.getAvailableShipsMatching("",!1,s.collection_only):x).length&&(this.ships.length<s.ship_limit||0===s.ship_limit)){if(x=x[$.randomInt(x.length)].name,0===(x=this.getAvailablePilotsForShipIncluding(x)).length)return;(x=x[$.randomInt(x.length)]).disabled||!(this.isQuickbuild?exportObj.pilots[exportObj.quickbuildsById[x.id].pilot]:exportObj.pilotsById[x.id]).sources.intersects(s.allowed_sources)||s.collection_only&&!this.collection.checkShelf("pilot",this.isQuickbuild?exportObj.quickbuildsById[x.id]:x.name)||this.addShip().setPilotById(x.id)}}else this.removeShip(this.ships[$.randomInt(this.ships.length)]);return window.setTimeout(this._makeRandomizerLoopFunc(s),0)}for(;this.total_points>s.max_points;)this.removeShip(this.ships[$.randomInt(this.ships.length)]);if(s.fill_zero_pts)for(u=0,r=(b=this.ships).length;u<r;u++)for(h=0,d=(_=(v=b[u]).upgrades).length;h<d;h++)null!=(n=_[h]).data||null!=n.occupied_by&&null!==n.occupied_by||(w=0<(t=function(){for(var t=this.getAvailableUpgradesIncluding(n.slot,null,n.ship,n,"",this.dfl_filter_func,!1),i=[],e=0,a=t.length;e<a;e++)w=t[e],exportObj.upgradesById[w.id].sources.intersects(s.allowed_sources)&&w.points<1&&(!s.collection_only||this.collection.checkShelf("upgrade",w.name))&&i.push(w);return i}.call(this)).length?t[$.randomInt(t.length)]:void 0)&&!w.disabled&&n.setById(w.id);for(window.clearTimeout(s.timer),p=0,c=(g=this.ships).length;p<c;p++)(v=g[p]).updateSelections();return this.suppress_automatic_new_ship=!1,this.addShip()}_makeRandomizerLoopFunc(t){return()=>this._randomizerLoopBody(t)}randomSquad(t=200,i=null,e=1e3,a=0,s=!0,n=!1){var l;for(this.backend_status.fadeOut("slow"),this.suppress_automatic_new_ship=!0,i.length<1&&(i=null);0<this.ships.length;)this.removeShip(this.ships[0]);if(0<this.ships.length)throw new Error("Ships not emptied");return(l={max_points:t,ship_limit:a,keep_running:!0,allowed_sources:null!=i?i:exportObj.expansions,collection_only:null!=this.collection&&"true"===this.collection.checks.collectioncheck&&s,fill_zero_pts:n}).timer=window.setTimeout(()=>l.keep_running=!1,e),window.setTimeout(this._makeRandomizerLoopFunc(l),0),this.resetCurrentSquad(),this.current_squad.name=this.uitranslation("Random Squad"),this.container.trigger("xwing-backend:squadNameChanged")}setBackend(t){var i,e,a,s,n;if(this.backend=t,null!=this.waiting_for_backend){for(n=[],i=0,e=(s=this.waiting_for_backend).length;i<e;i++)a=s[i],n.push(a());return n}}upgrade_effect(t){var i,e,a,s,n,l,o,r,d,c,u=c=e="";if(t.modifier_func&&(t.modifier_func(d={attack:0,attackf:0,attackbull:0,attackb:0,attackt:0,attackl:0,attackr:0,attackdt:0,energy:0,agility:0,hull:0,shields:0,force:0,actions:[],maneuvers:[0,0]}),0!==d.attack&&(c+=e+`%FRONTARC% (${d.attack})`,e=", "),0!==d.attackf&&(c+=e+`%FULLFRONTARC% (${d.attackf})`,e=", "),0!==d.attackbull&&(c+=e+`%BULLSEYEARC% (${d.attackbull})`,e=", "),0!==d.attackb&&(c+=e+`%REARARC% (${d.attackb})`,e=", "),0!==d.attackt&&(c+=e+`%SINGLETURRETARC% (${d.attackt})`,e=", "),0!==d.attackl&&(c+=e+`%LEFTARC% (${d.attackl})`,e=", "),0!==d.attackr&&(c+=e+`%RIGHTARC% (${d.attackr})`,e=", "),0!==d.attackdt&&(c+=e+`%DOUBLETURRETARC% (${d.attackdt})`,e=", "),0!==d.energy&&(c+=e+`%ENERGY% (${d.energy})`,e=", "),0!==d.agility&&(c+=e+`%AGILITY% (${d.agility})`,e=", "),0!==d.hull&&(c+=e+`%HULL% (${d.hull})`,e=", "),0!==d.shields&&(c+=e+`%SHIELD% (${d.shields})`,e=", "),0<d.actions.length)&&(c+=e+this.formatActions(d.actions,", "),e=", "),t.confersAddons)for(a=0,n=(o=t.confersAddons).length;a<n;a++)"Force"===(i=o[a]).slot?c+=e+"%FORCEPOWER%":c+=e+`%${i.slot.toUpperCase().replace(/[^a-z0-9]/gi,"")}%`,e=", ";if(t.unequips_upgrades)for(e="",s=0,l=(r=t.unequips_upgrades).length;s<l;s++)u+=e+`%${r[s].toUpperCase().replace(/[^a-z0-9]/gi,"")}%`,e=", ";return""!==c?(d={text:`</br><b>${this.uitranslation("adds",c)}</b>`},""!==u&&(d.text+=`</br><b>${this.uitranslation("removes",u)}</b>`),exportObj.fixIcons(d)):""}restriction_text(t){var i,e,a,s,n,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x=s=m=v="",k=!1,w=null!=t.standardized;if(this.isBeta&&null!=t.standardizedbeta&&(w=t.standardizedbeta),null!=t.restrictions&&(a=t.restrictions),null!=(a=this.isBeta&&null!=t.restrictionsbeta?t.restrictionsbeta:a))for(o=0,d=a.length;o<d;o++){switch((b=a[o])[0]){case"FactionOrUnique":m+=s+exportObj.translate("faction",""+b[2]),x=exportObj.translate("restrictions"," or Squad Including")+(" "+b[1]);break;case"Base":for(l=r=0,c=b.length;r<c;l=++r)"Base"===(e=b[l])?v+=s:(v+=e+" ",l<b.length-1?v+="or ":v+=exportObj.translate("restrictions","Ship"));break;case"Action":i=[b[1]],v+=s+this.formatActions(i,"",[]);break;case"Equipped":v+=s+`%${b[1].toUpperCase().replace(/[^a-z0-9]/gi,"")}% Equipped`;break;case"Slot":v+=s+exportObj.translate("restrictions","Extra")+` %${b[1].toUpperCase().replace(/[^a-z0-9]/gi,"")}%`;break;case"Keyword":v+=s+exportObj.translate("restrictions",""+b[1]),k=!0;break;case"AttackArc":v+=s+"%REARARC%";break;case"ShieldsGreaterThan":v+=s+("%SHIELD% > "+b[1]);break;case"EnergyGreatterThan":v+=s+("%ENERGY% > "+b[1]);break;case"InitiativeGreaterThan":v+=s+exportObj.translate("restrictions","Initiative")+(" > "+b[1]);break;case"InitiativeLessThan":v+=s+exportObj.translate("restrictions","Initiative")+(" < "+b[1]);break;case"HasForce":v+=s+(b[1]?"":"No ")+"%FORCE%";break;case"AgilityEquals":v+=s+exportObj.translate("restrictions","Agility")+(" = "+b[1]);break;case"isUnique":!0===b[1]?v+=s+exportObj.translate("restrictions","Limited"):v+=s+exportObj.translate("restrictions","Non-Limited");break;case"Format":v+=s+exportObj.translate("restrictions",b[1]+" Ship");break;case"Faction":m+=s+exportObj.translate("faction",""+b[1])}s=", "}if(!t.skill){if(""===m&&t.faction){if(t.faction instanceof Array)for(p=0,u=(_=t.faction).length;p<u;p++)n=_[p],m+=s+exportObj.translate("faction",""+n),s=" or ";else m+=s+exportObj.translate("faction",""+t.faction);s=", "}if(t.ship&&!1===k){if(t.ship instanceof Array)for(f=0,h=(g=t.ship).length;f<h;f++)m+=s+g[f],s=" or ";else m+=s+t.ship;s=", "}t.solitary&&(m+=s+exportObj.translate("gameterms","Solitary"),s=", "),w&&(m+=s+exportObj.translate("gameterms","Standardized"),s=", ")}return""!==(v+=m+x)?(t={text:"<i><b>"+exportObj.translate("restrictions","Restrictions")+":</b> "+v+"</i>"},exportObj.fixIcons(t)):""}describeSquad(){var s;return""===this.getNotes().trim()?function(){for(var t=this.ships,i=[],e=0,a=t.length;e<a;e++)null!=(s=t[e]).pilot&&i.push(s.pilot.name);return i}.call(this).join(", "):this.getNotes()}listCards(){for(var t,i,e,a,s,n={},l=this.ships,o=0,r=l.length;o<r;o++)if(null!=(a=l[o]).pilot)for(n[a.pilot.name]=null,t=0,i=(e=a.upgrades).length;t<i;t++)null!=(s=e[t]).data&&(n[s.data.name]=null);return Object.keys(n).sort()}getNotes(){return this.notes.val()}getTag(){return this.tag.val()}getObstacles(){return this.current_obstacles}isSquadPossibleWithCollection(){var t,i,e,a,s,n,l,o,r,d,c,u,h,p;if(0===Object.keys(null!=(l=null!=(l=this.collection)?l.expansions:void 0)?l:{}).length)return[!0,[]];if("true"!==(null!=(l=this.collection)?l.checks.collectioncheck:void 0))return[!0,[]];for(this.collection.reset(),p=!0,s=[],t=0,e=(o=this.ships).length;t<e;t++)if(null!=(d=o[t]).pilot&&(c=this.collection.use("ship",d.pilot.ship),n=this.collection.use("pilot",d.pilot.name),c&&n||(p=!1),c||s.push(d.data),n||s.push(d.pilot),null==d.pilot.upgrades))for(i=0,a=(r=d.upgrades).length;i<a;i++)null!=(u=r[i]).data&&((h=this.collection.use("upgrade",u.data.name))||null!=u.data.standard||(p=!1),h||null!=u.data.standard||s.push(u.data));return[p,s]}checkCollection(){var i,t;if(null!=this.collection)return[t,i]=this.isSquadPossibleWithCollection(),this.collection_invalid_container.toggleClass("d-none",t),this.collection_invalid_container.on("mouseover",t=>this.showTooltip("MissingStuff",i))}toXWS(){var t,i,e,a,s,n,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w,y,$="09/06/2024",q="AMG";for(this.isBeta&&($="BV4",q="XWA"),y={description:this.getNotes(),faction:exportObj.toXWSFaction[this.faction],name:this.current_squad.name,pilots:[],points:this.total_points,vendor:{yasb:{builder:"YASB - X-Wing 2.5",builder_url:window.location.href.split("?")[0],link:this.getPermaLink()}},version:$,ruleset:q},i=0,s=(b=this.ships).length;i<s;i++)null!=(x=b[i]).pilot&&y.pilots.push(x.toXWS());for(u={},e=a=0,_=(k=(()=>{for(var t=y.pilots,i=[],e=0,a=t.length;e<a;e++)null!=(f=t[e]).multisection&&i.push(f);return i})()).length**2;(0<=_?e<_:_<e)&&0!==k.length&&(null==(w=k.shift()).multisection_id&&(w.multisection_id=a++),null==u[h=w.multisection_id]&&(u[h]=[w]),0!==k.length);0<=_?++e:--e){for(c=[],r=0,n=k.length;r<n&&(t=k[r],g=w.name,!(0<=indexOf.call(t.multisection,g)&&(c.push(t),w.multisection.removeItem(t.name),t.multisection.removeItem(w.name),t.multisection_id=w.multisection_id,u[t.multisection_id].push(t),0===w.multisection.length)));r++);for(p=0,l=c.length;p<l;p++)0===(d=c[p]).multisection.length&&k.removeItem(d)}for(m=0,o=(v=y.pilots).length;m<o;m++)null!=(f=v[m]).multisection&&delete f.multisection;return null!=($=this.getObstacles())&&0<$.length&&(y.obstacles=$),y}toMinimalXWS(){var t,i,e=this.toXWS();for(t in e)hasProp.call(e,t)&&(e[t],"faction"!==t)&&"pilots"!==t&&"version"!==t&&delete e[t];for(t in i=e.pilots)hasProp.call(i,t)&&(i[t],"id"!==t)&&"upgrades"!==t&&"multisection_id"!==t&&delete e[t];return e}loadFromXWS(s,t){var i,e,a,n,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w,y,$,q=null,O=null,S=null!=s.version?(()=>{for(var t=s.version.split("."),i=[],e=0,a=t.length;e<a;e++)y=t[e],i.push(parseInt(y));return i})():[0,2];if(!1==!([0,1]<S)){if($=exportObj.fromXWSFaction[s.faction],this.faction!==$)throw new Error(`Attempted to load XWS for ${s.faction} but builder is `+this.faction);for(null!=s.name&&(this.current_squad.name=s.name),null!=s.description&&this.notes.val(s.description),null!=s.obstacles&&(this.current_squad.additional_data.obstacles=s.obstacles),this.suppress_automatic_new_ship=!0,this.removeAllShips(),q=!0,i=this.isStandard?"h":this.isEpic?"e":this.isBeta?"b":"s",_=O="",e=0,l=(p=s.pilots).length;e<l;e++){if(m=p[e],this.addShip(),m.id)c=m.id;else{if(!m.name){q=!1,O="Pilot without identifier";break}c=m.name}if(null!=exportObj.pilotsByFactionXWS[$][c])_+=exportObj.pilotsByFactionXWS[$][c][0].id;else if(exportObj.pilotsByUniqueName[c]&&1===exportObj.pilotsByUniqueName[c].length)_+=exportObj.pilotsByUniqueName[c][0].id;else for(a in f=exportObj.pilotsByUniqueName)for(n=0,o=(h=f[a]).length;n<o;n++)if((u=h[n]).xws&&u.xws===c||!u.xws&&a===c){_+=u.id;break}for(w in exportObj.standardCheck(m,!0)||"h"!==i||(i="s"),_+="X",b=null!=(m=m.upgrades)?m:{})for(d=0,r=(k=b[w]).length;d<r;d++)x=k[d],g=null!=(g=exportObj.fromXWSUpgrade[w])?g:w.capitalize(),null!=x&&(null==(v=null!=(v=exportObj.upgradesBySlotXWSName[g])[x]?v[x]:v[x]=exportObj.upgradesBySlotCanonicalName[g][x])?(console.log("Failed to load xws upgrade: "+x),O+="Skipped upgrade "+x,q=!1):(_=_+v.id+"W",exportObj.standardCheck(v,!0)||"h"!==i||(i="s")));_+="XY"}this.loadFromSerialized(_="v9Z"+i+"Z20Z"+_),this.current_squad.dirty=!0,this.container.trigger("xwing-backend:squadNameChanged"),this.container.trigger("xwing-backend:squadDirtinessChanged")}return t({success:q,error:O})}}return t}.call(this),Ship=class{constructor(t){this.builder=t.builder,this.container=t.container,this.pilot=null,this.data=null,this.quickbuildId=-1,this.linkedShip=null,this.primary=!0,this.upgrades=[],this.upgrade_points_total=0,this.wingmates=[],this.destroystate=0,this.uitranslation=this.builder.uitranslation,this.setupUI()}async destroy(t){var i;if(this.resetPilot(),this.resetAddons(),this.teardownUI(),(i=this.builder.ships.indexOf(this))<0)throw new Error("Ship not registered with builder");return this.builder.ships.splice(i,1),0<this.wingmates.length&&this.setWingmates(0),null!==this.linkedShip&&(0<(null!=(i=this.linkedShip.wingmates)?i.length:void 0)&&0<=indexOf.call(this.linkedShip.wingmates,this)?this.linkedShip.removeFromWing(this):(this.linkedShip.linkedShip=null,await this.builder.removeShip(this.linkedShip,defer()))),t()}copyFrom(s){var t,i,e,a,n,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w,y,$;if(s===this)throw new Error("Cannot copy from self");if(null!=s.pilot&&null!=s.data){if(this.builder.isQuickbuild){if(h=!(s.pilot.unique||null!=s.pilot.max_per_squad&&this.builder.countPilots(s.pilot.canonical_name)>=s.pilot.max_per_squad))for(a=0,l=(_=s.upgrades).length;a<l;a++)(null!=(null!=(g=($=_[a]).data)?g.unique:void 0)&&$.data.unique||null!=(null!=(g=$.data)?g.max_per_squad:void 0)&&this.builder.countUpgrades($.data.canonical_name)>=$.data.max_per_squad||null!=(null!=(g=$.data)?g.solitary:void 0))&&(h=!1);if(h)this.setPilotById(s.quickbuildId);else{if(!(0<(t=function(){for(var t=this.builder.getAvailablePilotsForShipIncluding(s.data.name),i=[],e=0,a=t.length;e<a;e++)(b=t[e]).disabled||i.push(b);return i}.call(this)).length))return;this.setPilotById(t[0].id,!0)}}else{if(s.pilot.unique||null!=s.pilot.max_per_squad&&this.builder.countPilots(s.pilot.canonical_name)>=s.pilot.max_per_squad){if(!(0<(t=function(){for(var t=this.builder.getAvailablePilotsForShipIncluding(s.data.name),i=[],e=0,a=t.length;e<a;e++)(b=t[e]).disabled||i.push(b);return i}.call(this)).length))return;this.setPilotById(t[0].id,!0)}else this.setPilotById(s.pilot.id,!0);for(m={},n=0,o=(v=s.upgrades).length;n<o;n++)null==(null!=($=v[n])?$.data:void 0)||$.isStandardized()||null!=$.data.standard||$.data.unique||!(null==$.data.max_per_squad||this.builder.countUpgrades($.data.canonical_name)<$.data.max_per_squad)||(null==m[u=$.slot]&&(m[u]=[]),m[$.slot].push($));for(i={},c=0,r=(x=this.upgrades).length;c<r;c++)($=x[c]).isOccupied()||null!=(f=(null!=(k=m[$.slot])?k:[]).shift())&&($.setById(f.data.id),$.lastSetValid||(i[f.data.id]=$));for(e in i)($=i[e]).setById(e);for(p=0,d=(w=this.upgrades).length;p<d;p++)($=w[p]).isOccupied()||null!=(f=(null!=(y=m[$.slot])?y:[]).shift())&&$.setById(f.data.id);this.addStandardizedUpgrades()}return this.updateSelections(),this.builder.container.trigger("xwing:pointsUpdated"),this.builder.current_squad.dirty=!0,this.builder.container.trigger("xwing-backend:squadDirtinessChanged")}}setShipType(n){var t,i,e,a,s,l;for(this.pilot_selector.data("select2").container.show(),n!==(null!=(a=this.pilot)?a.ship:void 0)&&(this.builder.isQuickbuild?(a=function(){for(var t=this.builder.getAvailablePilotsForShipIncluding(n),i=[],e=0,a=t.length;e<a;e++)(l=t[e]).disabled||i.push(l.id);return i}.call(this)[0],this.setPilotById(a)):this.setPilot(function(){for(var t,i=this.builder.getAvailablePilotsForShipIncluding(n),e=[],a=0,s=i.length;a<s;a++)l=i[a],null!=exportObj.pilotsById[l.id].restriction_func&&!exportObj.pilotsById[l.id].restriction_func(this)||(t=exportObj.pilotsById[l.id],0<=indexOf.call(this.builder.uniques_in_use.Pilot,t))||e.push(exportObj.pilotsById[l.id]);return e}.call(this)[0])),this.checkPilotSelectorQueryModal(),i=0,e=(s=this.row.attr("class").split(/\s+/)).length;i<e;i++)0===(t=s[i]).indexOf("ship-")&&this.row.removeClass(t);return this.remove_button.fadeIn("fast"),this.copy_button.fadeIn("fast"),!0===this.builder.show_points_destroyed&&this.points_destroyed_button.fadeIn("fast"),this.builder.container.trigger("xwing:shipUpdated")}async setPilotById(t,i=!1){var e,a,s,n,l;if(!this.builder.isQuickbuild)return this.setPilot(exportObj.pilotsById[parseInt(t)],i);if(t!==this.quickbuildId){if(this.wingmate_selector.parent().hide(),null!=this.wingmates&&0<this.wingmates.length&&this.setWingmates(0),this.quickbuildId=t,this.builder.current_squad.dirty=!0,this.resetPilot(),this.resetAddons(),null!=t&&-1<t){if(s=exportObj.quickbuildsById[parseInt(t)],i=exportObj.pilots[s.pilot],this.data=exportObj.ships[s.ship],this.builder.isUpdatingPoints=!0,null!=(null!=i?i.unique:void 0)&&await this.builder.container.trigger("xwing:claimUnique",[i,"Pilot",defer()]),this.pilot=i,null!=this.pilot&&this.setupAddons(),this.copy_button.show(),this.setShipType(this.pilot.ship),null!=s.wingmate&&null==this.linkedShip)for(e=0,a=(n=this.builder.ships).length;e<a;e++)if((l=n[e]).quickbuildId===s.linkedId)return l.joinWing(this),this.linkedShip=l,this.primary=!1,this.builder.isUpdatingPoints=!1,this.builder.container.trigger("xwing:pointsUpdated"),void this.builder.container.trigger("xwing-backend:squadDirtinessChanged");this.linkedShip?null!=s.linkedId?(this.linkedShip.setPilotById(s.linkedId),null==s.wingmate&&(this.linkedShip.primary=!1)):(0<(null!=(t=this.linkedShip.wingmates)?t.length:void 0)?this.linkedShip.removeFromWing(this):(this.linkedShip.linkedShip=null,await this.builder.removeShip(this.linkedShip,defer())),this.linkedShip=null):null!=s.linkedId&&(this.linkedShip=this.builder.ships.slice(-1)[0],null!==this.linkedShip.data?this.linkedShip=this.builder.addShip():this.builder.addShip(),(this.linkedShip.linkedShip=this).linkedShip.setPilotById(s.linkedId),null==s.wingmate)&&(this.linkedShip.primary=!1),this.primary=null==s.wingmate,null!=(null!=s?s.wingleader:void 0)&&(this.wingmate_selector.parent().show(),this.wingmate_selector.val(s.wingmates[0]),this.wingmate_selector.attr("min",s.wingmates[0]),this.wingmate_selector.attr("max",s.wingmates[s.wingmates.length-1]),this.setWingmates(s.wingmates[0])),this.builder.isUpdatingPoints=!1,this.builder.container.trigger("xwing:pointsUpdated")}else this.copy_button.hide();return this.row.removeClass("unsortable"),this.builder.container.trigger("xwing:pointsUpdated"),this.builder.container.trigger("xwing-backend:squadDirtinessChanged")}}addStandardizedUpgrades(){var t,i,e,a,s,n,l,o,r,d,c,u;if(!this.hasFixedUpgrades&&-1<(t=this.builder.standard_list.Ship.indexOf(null!=(n=this.data)?n.name:void 0))){for(d=(u=this.builder.standard_list.Upgrade[t]).restrictions||void 0,i=0,a=(l=this.upgrades).length;i<a;i++)if((null!=(o=(c=l[i]).data)?o.name:void 0)===u.name)return;for(e=0,s=(r=this.upgrades).length;e<s;e++)if(c=r[e],exportObj.slotsMatching(c.slot,this.builder.standard_list.Upgrade[t].slot)&&this.restriction_check(d,c)&&null==c.data)return void c.setData(u)}}addToStandardizedList(t){var i=this.builder.standard_list.Ship.indexOf(this.data.name);if(!(-1<i&&(null!=(i=this.builder.standard_list.Upgrade[i])?i.name:void 0)===t.name))return this.builder.standard_list.Upgrade.push(t),this.builder.standard_list.Ship.push(this.data.name)}removeStandardizedList(n){var t,i,e,a,s,l,o,r,d=this.builder.standard_list.Ship.indexOf(this.data.name);if(-1<d&&(null!=(e=this.builder.standard_list.Upgrade[d])?e.name:void 0)===n.name){for(this.builder.standard_list.Upgrade.splice(d,1),this.builder.standard_list.Ship.splice(d,1),l=[],t=0,i=(a=this.builder.ships).length;t<i;t++)(null!=(s=(o=a[t]).data)?s.name:void 0)===this.data.name&&o!==this?l.push((()=>{for(var t,i=o.upgrades,e=[],a=0,s=i.length;a<s;a++){if((null!=(t=(r=i[a]).data)?t.name:void 0)===n.name){r.setData(null);break}e.push(void 0)}return e})()):l.push(void 0);return l}}checkStandardizedList(t){var i,t=this.builder.standard_list.Ship.indexOf(t);if(-1<t&&null!=(null!=(i=this.builder.standard_list.Upgrade[t])?i.name:void 0))return this.builder.standard_list.Upgrade[t]}async setPilot(t,i=!1){var e,a,s,n,l,o,r,d,c,u,h,p,f,m,b,_,g,v,x,k,w,y,$,q,O,S,j,T;if(t!==this.pilot){if(this.builder.current_squad.dirty=!0,b={},($=null!=this.pilot&&(null!=t?t.ship:void 0)===this.pilot.ship)&&null==this.pilot.upgrades)for(l=0,r=(g=this.upgrades).length;l<r;l++)null!=(null!=(S=g[l])?S.data:void 0)&&(null==b[f=S.slot]&&(b[f]=[]),b[S.slot].push(S.data.id));if(this.resetPilot(),this.resetAddons(),null!=t){if(this.data=exportObj.ships[null!=t?t.ship:void 0],null!=(null!=t?t.unique:void 0)&&await this.builder.container.trigger("xwing:claimUnique",[t,"Pilot",defer()]),this.pilot=t,null!=this.pilot&&this.setupAddons(),this.copy_button.show(),this.setShipType(this.pilot.ship),(null!=this.pilot.autoequip||null!=exportObj.ships[this.pilot.ship].autoequip&&!$)&&!i)for(o=0,d=(a=(null!=(t=this.pilot.autoequip)?t:[]).concat(null!=(i=exportObj.ships[this.pilot.ship].autoequip)?i:[])).length;o<d;o++)for(j=a[o],e=exportObj.upgrades[j],p=0,c=(v=this.upgrades).length;p<c;p++)S=v[p],exportObj.slotsMatching(S.slot,e.slot)&&S.setData(e);if($&&null==this.pilot.upgrades){for(m=1;m<=2;++m){for(s={},_=0,u=(x=this.upgrades).length;_<u;_++)null!=(k=(null!=(k=b[(S=x[_]).slot])?k:[]).shift())&&(S.setById(k),S.lastSetValid||(s[k]=S));for(n in s)(S=s[n]).setById(n)}for(O=this.checkStandardizedList(this.pilot.ship),q=!1,T=0,h=(w=this.upgrades).length;T<h;T++)S=w[T],null!=O&&null!=(null!=S&&null!=(y=S.data)?y.name:void 0)&&S.data.name===O.name&&(q=!0);null!=O&&!1===q&&this.removeStandardizedList(O)}}else this.copy_button.hide();return this.row.removeClass("unsortable"),this.builder.container.trigger("xwing:pointsUpdated"),this.builder.container.trigger("xwing-backend:squadDirtinessChanged")}}async resetPilot(){var t;return null!=(null!=(t=this.pilot)?t.unique:void 0)&&await this.builder.container.trigger("xwing:releaseUnique",[this.pilot,"Pilot",defer()]),this.pilot=null}setupAddons(){var t,i,e,a,s,n,l,o,r,d,c,u,h,p,f,m,b;if(this.builder.isQuickbuild){for(h=[],n=0,s=(d=null!=(r=exportObj.quickbuildsById[this.quickbuildId].upgrades)?r:[]).length;n<s;n++)b=d[n],null==(m=exportObj.upgrades[b])?console.log("Unknown Upgrade: "+b):((f=new exportObj.QuickbuildUpgrade({ship:this,container:this.addon_container,slot:m.slot,upgrade:m})).setData(m),h.push(this.upgrades.push(f)));return h}if(null!=this.pilot.upgrades){for(this.hasFixedUpgrades=!0,c=[],t=0,e=(l=null!=(r=this.pilot.upgrades)?r:[]).length;t<e;t++)b=l[t],null==(m=exportObj.upgrades[b])?console.log("Unknown Upgrade: "+b):((f=new exportObj.QuickbuildUpgrade({ship:this,container:this.addon_container,slot:m.slot,upgrade:m})).setData(m),c.push(this.upgrades.push(f)));return c}for(this.hasFixedUpgrades=!1,u=[],i=0,a=(o=null!=(r=this.builder.isBeta&&null!=this.pilot.slotsbeta?this.pilot.slotsbeta:this.pilot.slots)?r:[]).length;i<a;i++)p=o[i],u.push(this.upgrades.push(new exportObj.Upgrade({ship:this,container:this.addon_container,slot:p})));return u}async resetAddons(){return await function(){for(var t,i=this.upgrades,e=[],a=0,s=i.length;a<s;a++)t=i[a],e.push(null!=t?t.destroy(defer()):void 0);return e},this.upgrades=[]}getPoints(){var t,i,e;return this.builder.isQuickbuild?(i=exportObj.quickbuildsById[this.quickbuildId],e=this.primary&&null!=(e=null!=i?i.threat:void 0)?e:0,null!=(null!=i?i.wingleader:void 0)&&(e=i.threat[i.wingmates.indexOf(this.wingmates.length)]),this.points_container.find("span").text(e),0<e?this.points_container.fadeTo("fast",1):this.points_container.fadeTo(0,0),e):(e=null!=this.pilot?(t=null!=(i=this.effectiveStats())?i.points:void 0,null!=i?i.loadout:void 0):t=0,this.points_container.find("div").text(""+t),this.points_container.find(".upgrade-points").text(null!=(null!=(i=this.pilot)?i.loadout:void 0)?`(${this.upgrade_points_total}/${e})`:""),0<t?this.points_container.fadeTo("fast",1):this.points_container.fadeTo(0,0),t)}async setWingmates(t){var i,e,a,s;if((null!=(s=this.wingmates)?s.length:void 0)!==t){for(null!=this.wingmates&&0!==this.wingmates.length||(this.wingmates=[]),a=exportObj.quickbuildsById[this.quickbuildId];this.wingmates.length<t;)null!==(e=this.builder.ships.slice(-1)[0]).data?e=this.builder.addShip():this.builder.addShip(),(e.linkedShip=this).wingmates.push(e),e.setPilotById(a.wingmateId),e.primary=!1,this.primary=!0;for(;this.wingmates.length>t;)(i=this.wingmates.pop()).linkedShip=null,await this.builder.removeShip(i,defer());return this.wingmate_selector.val(t)}}removeFromWing(t){var i;return this.wingmates.removeItem(t),t=exportObj.quickbuildsById[this.quickbuildId],i=this.wingmates.length,0<=indexOf.call(t.wingmates,i)||this.destroy($.noop),this.wingmate_selector.val(this.wingmates.length)}joinWing(t){var i,e;return this.wingmates.push(t),i=exportObj.quickbuildsById[this.quickbuildId],e=this.wingmates.length,0<=indexOf.call(i.wingmates,e)||(t.destroy($.noop),this.removeFromWing(t)),this.wingmate_selector.val(this.wingmates.length)}updateSelections(){var t,i,e,a,s,n,l;if(null==this.pilot)return this.pilot_selector.select2("data",null);for(this.ship_selector.select2("data",{id:this.pilot.ship,text:exportObj.ships[this.pilot.ship].display_name||this.pilot.ship,chassis:exportObj.ships[this.pilot.ship].chassis||"",xws:exportObj.ships[this.pilot.ship].name.canonicalize(),icon:exportObj.ships[this.pilot.ship].icon||exportObj.ships[this.pilot.ship].name.canonicalize()}),this.pilot_selector.select2("data",{id:this.pilot.id,text:`${null!=(null!=(a=exportObj.settings)?a.initiative_prefix:void 0)&&exportObj.settings.initiative_prefix?this.pilot.skill+" - ":""}${this.pilot.display_name||this.pilot.name}${-1!==this.quickbuildId?exportObj.quickbuildsById[this.quickbuildId].suffix:""} (${-1!==this.quickbuildId?this.primary?exportObj.quickbuildsById[this.quickbuildId].threat:0:this.builder.isBeta&&null!=this.pilot.pointsbeta?this.pilot.pointsbeta:this.pilot.points}${-1!==this.quickbuildId||null==this.pilot.loadout?"":this.builder.isBeta&&null!=this.pilot.loadoutbeta?"/"+this.pilot.loadoutbeta:"/"+this.pilot.loadout})`,chassis:null!=this.pilot.chassis?this.pilot.chassis:""}),this.pilot_selector.data("select2").container.show(),n=[],t=0,i=(s=this.upgrades).length;t<i;t++)e=(l=s[t]).getPoints(),n.push(l.updateSelection(e));return n}checkPilotSelectorQueryModal(){return 768<=$(window).width()?this.pilot_query_modal.hide():this.pilot?this.pilot_query_modal.show():void 0}setupUI(){var t;return this.row=$(document.createElement("DIV")),this.row.addClass("row ship mb-5 mb-sm-0 unsortable"),this.row.insertBefore(this.builder.notes_container),this.row.append($.trim(`<div class="col-md-3">
...
<div class="fancy-pilot-stats">
    <div class="pilot-stats-content">
        <span class="info-data info-skill">INI ${statAndEffectiveStat(this.pilot.skill,b,"skill")}</span>
        ${v}
        ${x}
        ${g}
        ${k}
        ...
        <span class="info-data info-agility">${statAndEffectiveStat(null!=(x=null!=(v=this.pilot.ship_override)?v.agility:void 0)?x:this.data.agility,b,"agility")}</span>                    
        ${e}
        <span class="info-data info-hull">${statAndEffectiveStat(null!=(k=null!=(g=this.pilot.ship_override)?g.hull:void 0)?k:this.data.hull,b,"hull")}</span>
        ${h}
        ${u}
        ${r}
        ${d}
...
</div>`),this.pilot.text&&(i+=$.trim(`<div class="fancy-pilot-text">${this.pilot.text}</div>`)),""!==(w=null!=(null!=b?b.chassis:void 0)&&""!==b.chassis?b.chassis:null!=this.data.chassis?this.data.chassis:"")&&(i+=$.trim(`<div class="fancy-pilot-chassis"><strong>${null!=(q=null!=(y=exportObj.chassis[w])?y.display_name:void 0)?q:w}:</strong> ${exportObj.chassis[w].text}</div>`)),0<(f=function(){for(var t=this.upgrades,i=[],e=0,a=t.length;e<a;e++)null!=(m=t[e]).data&&i.push(m);return i}.call(this)).length){for(i+=$.trim('<div class="fancy-upgrade-container">'),l=0,n=f.length;l<n;l++)o=(m=f[l]).getPoints(),i+=m.toHTML(o);i+=$.trim("</div>")}return O=Math.floor(this.getPoints()/2),S=Math.floor((b.hull+b.shields)/2),`<div class="fancy-ship">${i+=$.trim(`<div class="ship-points-total">
...
</tr>`),o=function(){for(var t=this.upgrades,i=[],e=0,a=t.length;e<a;e++)null!=(n=t[e]).data&&i.push(n);return i}.call(this);if(0<o.length)for(i=0,e=o.length;i<e;i++)a=(n=o[i]).getPoints(),l+=n.toTableRow(a);return l+=`<tr class="simple-ship-total"><td colspan="2">${this.uitranslation("Ship Cost")}: ${this.getPoints()}</td></tr>`,t=Math.floor(this.getPoints()/2),s=Math.floor((this.effectiveStats().hull+this.effectiveStats().shields)/2),l=l+`<tr class="simple-ship-half-points"><td colspan="2">${this.uitranslation("Loadout")}: (${this.upgrade_points_total}${this.builder.isBeta&&null!=this.pilot.loadoutbeta?"/"+this.pilot.loadoutbeta:null!=this.pilot.loadout?"/"+this.pilot.loadout:""}) ${this.uitranslation("Half Points")}: ${t} ${this.uitranslation("Damage Threshold")}: ${s}</td></tr>`+"<tr><td>&nbsp;</td><td></td></tr>"}toSimpleCopy(){var t,i,e,a,s,n,l,o=`${this.pilot.display_name} – ${this.data.display_name} (${-1!==this.quickbuildId?this.primary?exportObj.quickbuildsById[this.quickbuildId].threat:0:this.builder.isBeta&&null!=this.pilot.pointsbeta?this.pilot.pointsbeta:this.pilot.points})    \n`,r=function(){for(var t=this.upgrades,i=[],e=0,a=t.length;e<a;e++)null!=(n=t[e]).data&&i.push(n);return i}.call(this);if(0<r.length){for(o+="    ",a=[],i=0,e=r.length;i<e;i++)l=(n=r[i]).getPoints(),null!=(l=n.toSimpleCopy(l))&&a.push(l);o=o+a.join("    ")+`    
`}return t=Math.floor(this.getPoints()/2),s=Math.floor((this.effectiveStats().hull+this.effectiveStats().shields)/2),o+=""+this.uitranslation("Ship Cost")+`: ${this.getPoints()}  ${this.uitranslation("Loadout")}: (${this.upgrade_points_total}${this.builder.isBeta&&null!=this.pilot.loadoutbeta?"/"+this.pilot.loadoutbeta:null!=this.pilot.loadout?"/"+this.pilot.loadout:""})  ${this.uitranslation("Half Points")}: ${t}  ${this.uitranslation("Damage Threshold")}: ${s}    
    
`}toRedditText(){var t,i,e,a,s,n,l,o=`**${this.pilot.name} (${-1!==this.quickbuildId?this.primary?exportObj.quickbuildsById[this.quickbuildId].threat:0:this.builder.isBeta&&null!=this.pilot.pointsbeta?this.pilot.pointsbeta:this.pilot.points})**    
