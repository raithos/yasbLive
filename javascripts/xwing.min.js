...
</div>`)),exportObj.translateUIElements(this.randomizer_options_modal),this.randomizer_source_selector=$(this.randomizer_options_modal.find("select.randomizer-sources")),i=0,e=(n=exportObj.expansions).length;i<e;i++)t=n[i],(s=$(document.createElement("OPTION"))).text(t),this.randomizer_source_selector.append(s);return this.randomizer_source_selector.select2({width:"100%",minimumResultsForSearch:$.isMobile()?-1:0}),this.randomizer_collection_selector=$(this.randomizer_options_modal.find(".randomizer-collection-only"))[0],this.randomizer_fill_zero_pts=$(this.randomizer_options_modal.find(".randomizer-fill-zero-pts"))[0],this.randomize_button.click(t=>{var i,e;return t.preventDefault(),this.current_squad.dirty&&null!=this.backend?this.backend.warnUnsaved(this,()=>this.randomize_button.click()):(t=parseInt(this.desired_points_input.val()),(isNaN(t)||t<=0)&&(t=50),i=parseInt($(this.randomizer_options_modal.find(".randomizer-ship-limit")).val()),(isNaN(i)||i<0)&&(i=0),e=parseInt($(this.randomizer_options_modal.find(".randomizer-timeout")).val()),(isNaN(e)||e<=0)&&(e=4),this.randomSquad(t,this.randomizer_source_selector.val(),1e3*e,i,this.randomizer_collection_selector.checked,this.randomizer_fill_zero_pts.checked))}),this.randomizer_options_modal.find("button.do-randomize").click(t=>(t.preventDefault(),this.randomizer_options_modal.modal("hide"),this.randomize_button.click())),this.customize_randomizer.click(t=>(t.preventDefault(),this.randomizer_options_modal.modal())),this.misc_settings_modal=$(document.createElement("DIV")),this.misc_settings_modal.addClass("modal fade"),this.misc_settings_modal.tabindex="-1",this.misc_settings_modal.role="dialog",$("body").append(this.misc_settings_modal),this.misc_settings_modal.append($.trim(`<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
        <div class="modal-header">
...
</div>`)),this.ship_container=$(a.find("div.ship-container")),this.info_container=$(a.find("div.info-container")),this.obstacles_container=a.find(".obstacles-container"),this.notes_container=$(a.find(".notes-container")),this.notes=$(this.notes_container.find("textarea.squad-notes")),this.tag=$(this.notes_container.find("input.squad-tag")),this.ship_container.sortable({cancel:".unsortable"}),this.info_container.append($.trim(this.createInfoContainerUI())),this.info_container.find(".info-well").hide(),this.info_intro=this.info_container.find(".intro"),this.print_list_button=$(this.container.find("button.print-list")),this.container.find("[rel=tooltip]").tooltip(),this.obstacles_button=$(this.container.find("button.choose-obstacles")),this.obstacles_button.click(t=>(t.preventDefault(),this.showChooseObstaclesModal())),this.condition_container=$(document.createElement("div")),this.condition_container.addClass("conditions-container d-flex flex-wrap col-md-9"),this.container.append(this.condition_container),this.mobile_tooltip_modal=$(document.createElement("DIV")),this.mobile_tooltip_modal.addClass("modal fade choose-obstacles-modal d-print-none"),this.mobile_tooltip_modal.tabindex="-1",this.mobile_tooltip_modal.role="dialog",this.container.append(this.mobile_tooltip_modal),this.mobile_tooltip_modal.append($.trim(`<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
        <div class="modal-header">
        </div>
...
</div>`))}for(null!=(t=this.getPermaLinkParams(["sn","obs"]))&&this.list_modal.find(".toggle-juggler-qrcode").prop("checked")&&(this.printable_container.find(".printable-body").append($.trim(`<div class="qrcode-container">
