  ...
  return {
    quickbuildsById: [
      ...
      },
      {
        ...
        threat: 4,
        upgrades: ["Supernatural Reflexes",
      "Fire-Control System",
      "Afterburners",
      "Shield Upgrade",
      "Cluster Missiles"]
      ...
      },
      {
        ...
        ship: "Sheathipede-Class Shuttle",
        threat: 2,
        upgrades: ["Heightened Perception",
      '"Chopper" (Astromech)',
      "Afterburners",
      "Phantom"]
      },
      ...
      },
      {
        ...
        ship: "A/SF-01 B-wing",
        threat: 3,
        upgrades: ["B6 Blade Wing Prototype (Epic)",
      "Passive Sensors",
      "Deadeye Shot",
      "Sabine Wren (Gunner)"]
      },
      ...
      5],
        suffix: " and his wing",
        upgrades: ["Skystrike Academy Class",
      "Disciplined",
      "Marg Sabl Closure",
      "Sensitive Controls"],
        wingmateId: 530,
      ...
      },
      {
        ...
        ship: "BTL-A4 Y-wing",
        threat: 2,
        upgrades: ["Automated Target Priority",
      ...
      },
      {
        ...
        ship: "Droid Tri-fighter",
        threat: 2,
        upgrades: ["XX-23 S-Thread Tracers",
      "Intercept Booster"]
      },
      {
        id: 573,
      ...
      },
      {
        ...
        ship: "Trident-class Assault Ship",
        threat: 9,
        upgrades: ["Asajj Ventress (Command)",
      "Tractor Tentacles",
      "Enhanced Propulsion",
      "Seasoned Navigator",
      "Droid Crew",
      ...
      },
      {
        ...
        ship: "Gauntlet Fighter",
        threat: 4,
        upgrades: ["Imperial Super Commandos",
      "Drop-Seat Bay",
      "Hull Upgrade",
      "Shield Upgrade",
      "Swivel Wing"]
...
exportObj.setupQuickBuilds = function(basic_cards) {
  var i, j, k, len, len1, quickbuild_count, quickbuild_data, ref, ref1;
  ref = basic_cards.quickbuildsById;
  for (i = j = 0, len = ref.length; j < len; i = ++j) {
    quickbuild_data = ref[i];
  ...
  quickbuild_count = 0;
  ref1 = basic_cards.quickbuildsById;
  for (k = 0, len1 = ref1.length; k < len1; k++) {
    quickbuild_data = ref1[k];
