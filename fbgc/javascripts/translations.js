...
exportObj.translations.Deutsch = {
  ...
  ui: {
    ...
    varPointCostsPoints: function(translator, points) {
      return "<b>Kommandopunkte:</b> " + points + " für ";
    },
    varPointCostsConditionAgility: function(translator, values) {
      return "Wendigkeits " + values;
    },
